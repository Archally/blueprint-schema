...
For motivation, the handoff should make **strategic pressure visible**.

The receiver should be able to distinguish:

- goals from non-goals
- risks from assumptions
- trade-offs from decisions

If the handoff mixes these categories together, later design and governance work will blur.
