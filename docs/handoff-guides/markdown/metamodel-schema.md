# Metamodel Vocabulary Handoff Guide
...
- cross-layer ownership, tags, or version meanings where those shape handoff behavior
...
When handing off metamodel-vocabulary notes, optimize for **consistency** rather than volume.

A good handoff for this guide should make it easy to see:

- which terms are shared across many layers
- which terms are often confused and must stay distinct
- how the same thing should be named everywhere

If the receiver cannot tell whether two labels refer to the same concept, the handoff is not yet
strong enough.
