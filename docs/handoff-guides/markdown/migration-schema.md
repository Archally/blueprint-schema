...
When handing off migration notes, the most important thing is **change clarity**.

A good handoff should make it obvious:

- what is changing
- why it is changing
- what must happen first
- what makes rollback easy or hard

Do not send only release-style summaries. The receiver needs concrete affected entities,
