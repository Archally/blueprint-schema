...
```mermaid
graph LR
    QRY001["QRY001: Browse Products"]
    ACT001["ACT001: Customer browsing and purchasing products"]
    CMD001["CMD001: Add to Cart"]
    EVT001["EVT001: Item Added to Cart"]
    QRY002["QRY002: Browse by Category"]
    CMD002["CMD002: Submit Order"]
    EVT002["EVT002: Order Submitted"]
    CMD003["CMD003: Cancel Order"]
    EVT003["EVT003: Order Cancelled"]
    CMD004["CMD004: Process Payment"]
    EVT004["EVT004: Payment Confirmed"]
    EVT005["EVT005: Payment Failed"]
...
graph TD
    ...
    subgraph design_rules["design.rules"]
        SR002["SR002: Product must belong to a category"]
        SR001["SR001: Order must have items"]
        VR001["VR001: Cancel before shipment only"]
    end
    subgraph governance_tests["governance.tests"]
        TC002["TC002: Every product is assigned to at least one category."]
        TC001["TC001: Order with at least one item submits successfully."]
        EC001["EC001: Order in submitted status can be cancelled."]
    end
    subgraph design_story["design.story"]
        STR001["STR001: Customer Places Order"]
        US001["US001: place an order for products in my cart"]
    end
