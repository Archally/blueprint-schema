...
```mermaid
graph LR
    Catalog["Product catalog — CRUD, variants, media, categories, attributes, suppliers, search indexing."]
    Orders["Order lifecycle — placement, state management, cancellation, refund, invoice, returns, credit slips."]
    Checkout["Cart management, checkout flow, cart rules, promotions, payment orchestration."]
    Customers["Customer accounts, addresses, customer service messaging, titles."]
    Shipping["Carrier configuration, shipping cost calculation, shipment tracking."]
    International["Currencies, countries, zones, languages, tax rules — localization backbone."]
    Content["CMS pages, page categories, themes, email templates, SEO meta."]
    Modules["Module lifecycle, hook system, module marketplace integration."]
    Admin["Employee accounts, profiles, security, API clients, configuration."]
    Shop["Multi-store configuration, physical stores, contacts, search, aliases."]
    ExternalApiConsumers["External systems consuming PrestaShop Admin API via OAuth2."]
```
...
graph LR
    ...
    admin_EVT014["admin.EVT014"]
    admin_ACT003["admin.ACT003"]
    admin_CMD022["admin.CMD022"]
    admin_EVT015["admin.EVT015"]
    admin_CMD023["admin.CMD023"]
    admin_EVT016["admin.EVT016"]
    admin_CMD024["admin.CMD024"]
    admin_EVT017["admin.EVT017"]
    admin_CMD025["admin.CMD025"]
    admin_EVT018["admin.EVT018"]
    admin_CMD026["admin.CMD026"]
    admin_EVT019["admin.EVT019"]
    admin_CMD027["admin.CMD027"]
    admin_EVT020["admin.EVT020"]
    admin_CMD028["admin.CMD028"]
    admin_CMD029["admin.CMD029"]
    admin_EVT021["admin.EVT021"]
    admin_ACT001["admin.ACT001"]
    admin_CMD030["admin.CMD030"]
    admin_EVT022["admin.EVT022"]
    admin_CMD031["admin.CMD031"]
    admin_EVT023["admin.EVT023"]
    admin_CMD032["admin.CMD032"]
    admin_CMD033["admin.CMD033"]
    admin_EVT024["admin.EVT024"]
    admin_CMD034["admin.CMD034"]
    admin_EVT025["admin.EVT025"]
    admin_CMD035["admin.CMD035"]
    admin_EVT026["admin.EVT026"]
    admin_CMD001["admin.CMD001"]
    admin_EVT001["admin.EVT001"]
    admin_CMD002["admin.CMD002"]
    admin_EVT002["admin.EVT002"]
    admin_CMD003["admin.CMD003"]
    admin_EVT003["admin.EVT003"]
    admin_CMD004["admin.CMD004"]
    admin_EVT004["admin.EVT004"]
    admin_CMD005["admin.CMD005"]
    admin_CMD006["admin.CMD006"]
    admin_CMD007["admin.CMD007"]
    admin_EVT005["admin.EVT005"]
    admin_CMD008["admin.CMD008"]
    admin_EVT006["admin.EVT006"]
    admin_ACT002["admin.ACT002"]
    admin_CMD009["admin.CMD009"]
    admin_EVT007["admin.EVT007"]
    admin_CMD010["admin.CMD010"]
    admin_EVT008["admin.EVT008"]
    admin_CMD011["admin.CMD011"]
    admin_EVT009["admin.EVT009"]
    admin_CMD012["admin.CMD012"]
    admin_CMD013["admin.CMD013"]
    admin_EVT010["admin.EVT010"]
    admin_CMD014["admin.CMD014"]
    admin_EVT011["admin.EVT011"]
    admin_CMD015["admin.CMD015"]
    admin_EVT012["admin.EVT012"]
    admin_CMD016["admin.CMD016"]
    admin_EVT013["admin.EVT013"]
    admin_CMD017["admin.CMD017"]
    admin_CMD018["admin.CMD018"]
    admin_CMD019["admin.CMD019"]
    admin_CMD020["admin.CMD020"]
    catalog_CMD025["catalog.CMD025"]
    catalog_EVT009["catalog.EVT009"]
    catalog_CMD026["catalog.CMD026"]
    catalog_EVT010["catalog.EVT010"]
    catalog_CMD027["catalog.CMD027"]
    catalog_CMD028["catalog.CMD028"]
    catalog_CMD029["catalog.CMD029"]
    catalog_CMD030["catalog.CMD030"]
    catalog_EVT002["catalog.EVT002"]
    catalog_CMD031["catalog.CMD031"]
    catalog_CMD032["catalog.CMD032"]
    catalog_CMD033["catalog.CMD033"]
    catalog_CMD011["catalog.CMD011"]
    catalog_EVT004["catalog.EVT004"]
    catalog_CMD012["catalog.CMD012"]
    catalog_EVT005["catalog.EVT005"]
    catalog_CMD013["catalog.CMD013"]
    catalog_CMD014["catalog.CMD014"]
    catalog_CMD015["catalog.CMD015"]
    catalog_CMD040["catalog.CMD040"]
    catalog_CMD041["catalog.CMD041"]
    catalog_CMD016["catalog.CMD016"]
    catalog_EVT006["catalog.EVT006"]
    catalog_CMD017["catalog.CMD017"]
    catalog_CMD018["catalog.CMD018"]
    catalog_CMD019["catalog.CMD019"]
    catalog_CMD020["catalog.CMD020"]
    catalog_CMD021["catalog.CMD021"]
    catalog_EVT007["catalog.EVT007"]
    catalog_CMD022["catalog.CMD022"]
    catalog_CMD023["catalog.CMD023"]
    catalog_CMD024["catalog.CMD024"]
    catalog_CMD001["catalog.CMD001"]
    catalog_EVT001["catalog.EVT001"]
    catalog_ACT001["Merchandising and catalog curation."]
    catalog_CMD002["catalog.CMD002"]
    catalog_CMD003["catalog.CMD003"]
    catalog_EVT003["catalog.EVT003"]
    catalog_CMD004["catalog.CMD004"]
    catalog_CMD005["catalog.CMD005"]
    catalog_CMD006["catalog.CMD006"]
    catalog_CMD007["catalog.CMD007"]
    catalog_EVT008["catalog.EVT008"]
    catalog_CMD008["catalog.CMD008"]
    catalog_CMD009["catalog.CMD009"]
    catalog_CMD010["catalog.CMD010"]
    catalog_CMD034["catalog.CMD034"]
    catalog_CMD035["catalog.CMD035"]
    catalog_CMD036["catalog.CMD036"]
    catalog_CMD037["catalog.CMD037"]
    catalog_CMD038["catalog.CMD038"]
    catalog_CMD039["catalog.CMD039"]
    checkout_CMD001["checkout.CMD001"]
    checkout_EVT001["checkout.EVT001"]
    orders_ACT004["Customer support and tech ops."]
    checkout_CMD002["checkout.CMD002"]
    checkout_EVT002["checkout.EVT002"]
    checkout_CMD003["checkout.CMD003"]
    checkout_CMD004["checkout.CMD004"]
    checkout_CMD005["checkout.CMD005"]
    checkout_CMD006["checkout.CMD006"]
    checkout_CMD007["checkout.CMD007"]
    checkout_EVT003["checkout.EVT003"]
    checkout_CMD008["checkout.CMD008"]
    checkout_CMD009["checkout.CMD009"]
    checkout_EVT004["checkout.EVT004"]
    orders_ACT001["Online consumer purchasing products."]
    checkout_CMD010["checkout.CMD010"]
    checkout_CMD011["checkout.CMD011"]
    checkout_CMD012["checkout.CMD012"]
    checkout_CMD013["checkout.CMD013"]
    checkout_CMD014["checkout.CMD014"]
    checkout_EVT005["checkout.EVT005"]
    checkout_CMD015["checkout.CMD015"]
    checkout_EVT006["checkout.EVT006"]
    checkout_CMD016["checkout.CMD016"]
    checkout_EVT007["checkout.EVT007"]
    checkout_ACT001["checkout.ACT001"]
    checkout_CMD017["checkout.CMD017"]
    checkout_EVT008["checkout.EVT008"]
    checkout_CMD018["checkout.CMD018"]
    checkout_EVT009["checkout.EVT009"]
    checkout_CMD019["checkout.CMD019"]
    checkout_CMD020["checkout.CMD020"]
    checkout_CMD021["checkout.CMD021"]
    checkout_EVT010["checkout.EVT010"]
    checkout_CMD022["checkout.CMD022"]
    checkout_EVT011["checkout.EVT011"]
    checkout_CMD023["checkout.CMD023"]
    checkout_EVT012["checkout.EVT012"]
    content_CMD001["content.CMD001"]
    content_EVT001["content.EVT001"]
    content_ACT001["content.ACT001"]
    content_CMD002["content.CMD002"]
    content_EVT002["content.EVT002"]
    content_CMD003["content.CMD003"]
    content_EVT003["content.EVT003"]
    content_CMD004["content.CMD004"]
    content_CMD005["content.CMD005"]
    content_EVT004["content.EVT004"]
    content_CMD006["content.CMD006"]
    content_QRY001["content.QRY001"]
    content_QRY002["content.QRY002"]
    content_CMD007["content.CMD007"]
    content_EVT005["content.EVT005"]
    content_CMD008["content.CMD008"]
    content_EVT006["content.EVT006"]
    content_CMD009["content.CMD009"]
    content_EVT007["content.EVT007"]
    content_CMD010["content.CMD010"]
    content_CMD011["content.CMD011"]
    content_EVT008["content.EVT008"]
    content_CMD012["content.CMD012"]
    content_QRY003["content.QRY003"]
    content_QRY004["content.QRY004"]
    content_QRY005["content.QRY005"]
    content_QRY006["content.QRY006"]
    content_CMD019["content.CMD019"]
    content_EVT015["content.EVT015"]
    content_CMD020["content.CMD020"]
    content_EVT016["content.EVT016"]
    content_QRY007["content.QRY007"]
    content_QRY008["content.QRY008"]
    content_ACT002["content.ACT002"]
    content_CMD013["content.CMD013"]
    content_EVT009["content.EVT009"]
    content_CMD014["content.CMD014"]
    content_EVT010["content.EVT010"]
    content_CMD015["content.CMD015"]
    content_EVT011["content.EVT011"]
    content_CMD016["content.CMD016"]
    content_EVT012["content.EVT012"]
    content_CMD017["content.CMD017"]
    content_EVT013["content.EVT013"]
    content_CMD018["content.CMD018"]
    content_EVT014["content.EVT014"]
    customers_CMD012["customers.CMD012"]
    customers_EVT007["customers.EVT007"]
    customers_ACT001["customers.ACT001"]
    customers_CMD013["customers.CMD013"]
    customers_EVT008["customers.EVT008"]
    customers_CMD014["customers.CMD014"]
    customers_EVT009["customers.EVT009"]
    customers_CMD015["customers.CMD015"]
    customers_CMD001["customers.CMD001"]
    customers_EVT001["customers.EVT001"]
    customers_CMD002["customers.CMD002"]
    customers_EVT002["customers.EVT002"]
    customers_CMD003["customers.CMD003"]
    customers_EVT003["customers.EVT003"]
    customers_CMD004["customers.CMD004"]
    customers_CMD005["customers.CMD005"]
    customers_CMD006["customers.CMD006"]
    customers_CMD007["customers.CMD007"]
    customers_CMD008["customers.CMD008"]
    customers_EVT004["customers.EVT004"]
    customers_CMD009["customers.CMD009"]
    customers_EVT005["customers.EVT005"]
    customers_CMD010["customers.CMD010"]
    customers_EVT006["customers.EVT006"]
    customers_CMD011["customers.CMD011"]
    customers_CMD016["customers.CMD016"]
    customers_EVT010["customers.EVT010"]
    customers_ACT002["customers.ACT002"]
    customers_CMD017["customers.CMD017"]
    customers_EVT011["customers.EVT011"]
    customers_CMD018["customers.CMD018"]
    customers_EVT012["customers.EVT012"]
    customers_CMD019["customers.CMD019"]
    customers_CMD020["customers.CMD020"]
    customers_EVT013["customers.EVT013"]
    customers_CMD021["customers.CMD021"]
    customers_EVT014["customers.EVT014"]
    customers_CMD022["customers.CMD022"]
    international_CMD001["international.CMD001"]
    international_EVT001["international.EVT001"]
    international_ACT001["international.ACT001"]
    international_CMD002["international.CMD002"]
    international_EVT002["international.EVT002"]
    international_CMD003["international.CMD003"]
    international_EVT003["international.EVT003"]
    international_CMD004["international.CMD004"]
    international_EVT004["international.EVT004"]
    international_CMD005["international.CMD005"]
    international_EVT005["international.EVT005"]
    international_CMD006["international.CMD006"]
    international_EVT006["international.EVT006"]
    international_CMD011["international.CMD011"]
    international_EVT011["international.EVT011"]
    international_CMD012["international.CMD012"]
    international_EVT012["international.EVT012"]
    international_CMD013["international.CMD013"]
    international_EVT013["international.EVT013"]
    international_CMD014["international.CMD014"]
    international_EVT014["international.EVT014"]
    international_CMD015["international.CMD015"]
    international_EVT015["international.EVT015"]
    international_CMD016["international.CMD016"]
    international_EVT016["international.EVT016"]
    international_CMD017["international.CMD017"]
    international_EVT017["international.EVT017"]
    international_CMD018["international.CMD018"]
    international_EVT018["international.EVT018"]
    international_CMD019["international.CMD019"]
    international_EVT019["international.EVT019"]
    international_CMD020["international.CMD020"]
    international_EVT020["international.EVT020"]
    international_CMD021["international.CMD021"]
    international_EVT021["international.EVT021"]
    international_CMD022["international.CMD022"]
    international_EVT022["international.EVT022"]
    international_CMD007["international.CMD007"]
    international_EVT007["international.EVT007"]
    international_CMD008["international.CMD008"]
    international_EVT008["international.EVT008"]
    international_CMD009["international.CMD009"]
    international_EVT009["international.EVT009"]
    international_CMD010["international.CMD010"]
    international_EVT010["international.EVT010"]
    international_CMD023["international.CMD023"]
    international_EVT023["international.EVT023"]
    international_ACT002["international.ACT002"]
    international_CMD024["international.CMD024"]
    international_EVT024["international.EVT024"]
    international_CMD025["international.CMD025"]
    international_EVT025["international.EVT025"]
    international_CMD026["international.CMD026"]
    international_EVT026["international.EVT026"]
    international_CMD027["international.CMD027"]
    international_EVT027["international.EVT027"]
    international_CMD028["international.CMD028"]
    international_EVT028["international.EVT028"]
    international_CMD029["international.CMD029"]
    international_EVT029["international.EVT029"]
    international_CMD030["international.CMD030"]
    international_EVT030["international.EVT030"]
    modules_CMD001["modules.CMD001"]
    modules_EVT001["modules.EVT001"]
    modules_ACT001["modules.ACT001"]
    modules_CMD002["modules.CMD002"]
    modules_EVT002["modules.EVT002"]
    modules_CMD003["modules.CMD003"]
    modules_EVT003["modules.EVT003"]
    modules_CMD004["modules.CMD004"]
    modules_CMD005["modules.CMD005"]
    modules_CMD006["modules.CMD006"]
    modules_EVT004["modules.EVT004"]
    modules_CMD007["modules.CMD007"]
    modules_EVT005["modules.EVT005"]
    modules_CMD008["modules.CMD008"]
    modules_EVT006["modules.EVT006"]
    modules_ACT002["modules.ACT002"]
    modules_QRY001["modules.QRY001"]
    modules_CMD009["modules.CMD009"]
    modules_EVT007["modules.EVT007"]
    modules_QRY002["modules.QRY002"]
    modules_QRY003["modules.QRY003"]
    orders_CMD017["orders.CMD017"]
    orders_EVT007["orders.EVT007"]
    orders_ACT003["Store owner and operator."]
    orders_CMD018["orders.CMD018"]
    orders_CMD019["orders.CMD019"]
    orders_EVT008["orders.EVT008"]
    orders_CMD024["orders.CMD024"]
    orders_CMD025["orders.CMD025"]
    orders_CMD026["orders.CMD026"]
    orders_CMD027["orders.CMD027"]
    orders_CMD028["orders.CMD028"]
    orders_CMD029["orders.CMD029"]
    orders_CMD030["orders.CMD030"]
    orders_CMD031["orders.CMD031"]
    orders_CMD032["orders.CMD032"]
    orders_CMD033["orders.CMD033"]
    orders_CMD034["orders.CMD034"]
    orders_CMD035["orders.CMD035"]
    orders_CMD036["orders.CMD036"]
    orders_CMD001["orders.CMD001"]
    orders_EVT001["orders.EVT001"]
    orders_CMD004["orders.CMD004"]
    orders_EVT005["orders.EVT005"]
    orders_CMD002["orders.CMD002"]
    orders_EVT002["orders.EVT002"]
    orders_CMD005["orders.CMD005"]
    orders_CMD006["orders.CMD006"]
    orders_CMD007["orders.CMD007"]
    orders_CMD008["orders.CMD008"]
    orders_CMD009["orders.CMD009"]
    orders_CMD010["orders.CMD010"]
    orders_CMD011["orders.CMD011"]
    orders_CMD012["orders.CMD012"]
    orders_CMD013["orders.CMD013"]
    orders_CMD014["orders.CMD014"]
    orders_EVT004["orders.EVT004"]
    orders_CMD020["orders.CMD020"]
    orders_EVT009["orders.EVT009"]
    orders_CMD021["orders.CMD021"]
    orders_CMD022["orders.CMD022"]
    orders_CMD003["orders.CMD003"]
    orders_EVT003["orders.EVT003"]
    orders_EVT006["orders.EVT006"]
    orders_CMD015["orders.CMD015"]
    orders_CMD016["orders.CMD016"]
    orders_CMD023["orders.CMD023"]
    orders_EVT010["orders.EVT010"]
    shipping_CMD001["shipping.CMD001"]
    shipping_EVT001["shipping.EVT001"]
    shipping_ACT001["shipping.ACT001"]
    shipping_CMD002["shipping.CMD002"]
    shipping_EVT002["shipping.EVT002"]
    shipping_CMD003["shipping.CMD003"]
    shipping_EVT003["shipping.EVT003"]
    shipping_CMD004["shipping.CMD004"]
    shipping_CMD005["shipping.CMD005"]
    shipping_EVT004["shipping.EVT004"]
    shipping_CMD006["shipping.CMD006"]
    shipping_CMD007["shipping.CMD007"]
    shipping_EVT005["shipping.EVT005"]
    shipping_CMD008["shipping.CMD008"]
    shipping_EVT006["shipping.EVT006"]
    shipping_CMD009["shipping.CMD009"]
    shipping_EVT007["shipping.EVT007"]
    shipping_CMD010["shipping.CMD010"]
    shipping_EVT008["shipping.EVT008"]
    shipping_CMD011["shipping.CMD011"]
    shipping_EVT009["shipping.EVT009"]
    shipping_CMD012["shipping.CMD012"]
    shipping_EVT010["shipping.EVT010"]
    shipping_CMD013["shipping.CMD013"]
    shipping_EVT011["shipping.EVT011"]
    shipping_CMD014["shipping.CMD014"]
    shipping_EVT012["shipping.EVT012"]
    shipping_CMD015["shipping.CMD015"]
    shipping_EVT013["shipping.EVT013"]
    shipping_CMD016["shipping.CMD016"]
    shipping_EVT014["shipping.EVT014"]
    shipping_CMD017["shipping.CMD017"]
    shipping_EVT015["shipping.EVT015"]
    shop_CMD001["shop.CMD001"]
    shop_EVT001["shop.EVT001"]
    shop_ACT001["shop.ACT001"]
    shop_CMD002["shop.CMD002"]
    shop_EVT002["shop.EVT002"]
    shop_CMD003["shop.CMD003"]
    shop_EVT003["shop.EVT003"]
    shop_CMD004["shop.CMD004"]
    shop_CMD005["shop.CMD005"]
    shop_CMD006["shop.CMD006"]
    shop_EVT004["shop.EVT004"]
    shop_ACT002["shop.ACT002"]
    shop_CMD007["shop.CMD007"]
    shop_EVT005["shop.EVT005"]
    shop_CMD008["shop.CMD008"]
    shop_EVT006["shop.EVT006"]
    shop_CMD009["shop.CMD009"]
    shop_CMD010["shop.CMD010"]
    shop_EVT007["shop.EVT007"]
    shop_CMD011["shop.CMD011"]
    shop_EVT008["shop.EVT008"]
    shop_CMD012["shop.CMD012"]
    shop_EVT009["shop.EVT009"]
    shop_CMD013["shop.CMD013"]
    shop_CMD014["shop.CMD014"]
    shop_EVT010["shop.EVT010"]
    shop_CMD015["shop.CMD015"]
    shop_EVT011["shop.EVT011"]
    shop_CMD016["shop.CMD016"]
    shop_EVT012["shop.EVT012"]
    shop_CMD017["shop.CMD017"]
    shop_EVT013["shop.EVT013"]
    shop_CMD018["shop.CMD018"]
    shop_EVT014["shop.EVT014"]
...
graph TD
    subgraph design_concepts["design.concepts"]
        admin_CN005["admin.CN005"]
        admin_CN006["admin.CN006"]
        admin_ACT003["admin.ACT003"]
        admin_CN007["admin.CN007"]
        admin_CN008["admin.CN008"]
        admin_CN009["admin.CN009"]
        admin_CN001["admin.CN001"]
        admin_CN002["admin.CN002"]
        admin_CN003["admin.CN003"]
        admin_CN004["admin.CN004"]
        admin_ACT001["admin.ACT001"]
        admin_ACT002["admin.ACT002"]
        admin_EN001["admin.EN001"]
        admin_AS001["admin.AS001"]
        admin_AS002["admin.AS002"]
        catalog_CN002["catalog.CN002"]
        catalog_CN005["catalog.CN005"]
        catalog_CN006["catalog.CN006"]
        catalog_CN007["catalog.CN007"]
        catalog_CN014["catalog.CN014"]
        catalog_CN001["catalog.CN001"]
        catalog_CN003["catalog.CN003"]
        catalog_CN004["catalog.CN004"]
        catalog_CN010["catalog.CN010"]
        catalog_CN013["catalog.CN013"]
        catalog_CN012["catalog.CN012"]
        catalog_CN011["catalog.CN011"]
        catalog_ACT001["Merchandising and catalog curation."]
        catalog_EN001["catalog.EN001"]
        catalog_EN002["catalog.EN002"]
        catalog_EN003["catalog.EN003"]
        catalog_AS001["catalog.AS001"]
        catalog_AS002["catalog.AS002"]
        catalog_AS003["catalog.AS003"]
        catalog_CN008["catalog.CN008"]
        catalog_CN009["catalog.CN009"]
        checkout_CN001["checkout.CN001"]
        checkout_CN002["checkout.CN002"]
        checkout_CN003["checkout.CN003"]
        checkout_EN001["checkout.EN001"]
        checkout_EN002["checkout.EN002"]
        checkout_AS001["checkout.AS001"]
        checkout_AS002["checkout.AS002"]
        checkout_CN004["checkout.CN004"]
        checkout_CN005["checkout.CN005"]
        checkout_ACT001["checkout.ACT001"]
        checkout_EN003["checkout.EN003"]
        checkout_EN004["checkout.EN004"]
        checkout_EN005["checkout.EN005"]
        checkout_AS003["checkout.AS003"]
        checkout_CN006["checkout.CN006"]
        content_CN001["content.CN001"]
        content_CN002["content.CN002"]
        content_ACT001["content.ACT001"]
        content_EN001["content.EN001"]
        content_AS001["content.AS001"]
        content_AS002["content.AS002"]
        content_CN005["content.CN005"]
        content_CN003["content.CN003"]
        content_CN004["content.CN004"]
        content_ACT002["content.ACT002"]
        content_EN002["content.EN002"]
        customers_CN004["customers.CN004"]
        customers_AS002["customers.AS002"]
        customers_CN005["customers.CN005"]
        customers_EN003["customers.EN003"]
        customers_AS003["customers.AS003"]
        customers_CN001["customers.CN001"]
        customers_CN002["customers.CN002"]
        customers_CN003["customers.CN003"]
        customers_ACT001["customers.ACT001"]
        customers_ACT002["customers.ACT002"]
        customers_EN001["customers.EN001"]
        customers_EN002["customers.EN002"]
        customers_AS001["customers.AS001"]
        international_CN004["international.CN004"]
        international_CN005["international.CN005"]
        international_CN006["international.CN006"]
        international_AS002["international.AS002"]
        international_AS003["international.AS003"]
        international_AS004["international.AS004"]
        international_CN001["international.CN001"]
        international_CN002["international.CN002"]
        international_CN003["international.CN003"]
        international_ACT001["international.ACT001"]
        international_EN001["international.EN001"]
        international_AS001["international.AS001"]
        international_CN007["international.CN007"]
        international_CN008["international.CN008"]
        international_CN009["international.CN009"]
        international_ACT002["international.ACT002"]
        international_AS005["international.AS005"]
        international_AS006["international.AS006"]
        international_AS007["international.AS007"]
        modules_CN001["modules.CN001"]
        modules_CN002["modules.CN002"]
        modules_ACT001["modules.ACT001"]
        modules_ACT002["modules.ACT002"]
        modules_EN001["modules.EN001"]
        modules_AS001["modules.AS001"]
        orders_CN010["orders.CN010"]
        orders_CN011["orders.CN011"]
        orders_CN002["orders.CN002"]
        orders_CN003["orders.CN003"]
        orders_CN006["orders.CN006"]
        orders_CN005["orders.CN005"]
        orders_CN004["orders.CN004"]
        orders_ACT001["Online consumer purchasing products."]
        orders_ACT002["Technical architect for order processing."]
        orders_ACT003["Store owner and operator."]
        orders_ACT004["Customer support and tech ops."]
        orders_EN001["orders.EN001"]
        orders_EN002["orders.EN002"]
        orders_AS001["orders.AS001"]
        orders_AS002["orders.AS002"]
        orders_CN007["orders.CN007"]
        orders_CN008["orders.CN008"]
        orders_CN009["orders.CN009"]
        shipping_CN001["shipping.CN001"]
        shipping_CN002["shipping.CN002"]
        shipping_CN003["shipping.CN003"]
        shipping_ACT001["shipping.ACT001"]
        shipping_EN001["shipping.EN001"]
        shipping_EN002["shipping.EN002"]
        shipping_AS001["shipping.AS001"]
        shipping_CN004["shipping.CN004"]
        shipping_CN005["shipping.CN005"]
        shipping_AS002["shipping.AS002"]
        shipping_AS003["shipping.AS003"]
        shop_CN001["shop.CN001"]
        shop_CN002["shop.CN002"]
        shop_CN003["shop.CN003"]
        shop_CN004["shop.CN004"]
        shop_CN005["shop.CN005"]
        shop_CN006["shop.CN006"]
        shop_CN007["shop.CN007"]
        shop_CN008["shop.CN008"]
        shop_ACT001["shop.ACT001"]
        shop_ACT002["shop.ACT002"]
        shop_AS001["shop.AS001"]
    end
    subgraph design_domain["design.domain"]
        ...
        admin_EVT020["admin.EVT020"]
        admin_CMD028["admin.CMD028"]
        admin_QRY006["admin.QRY006"]
        admin_ERR006["ApiClientNotFound"]
        admin_ERR007["InvalidApiScopes"]
        admin_ERR008["WebserviceKeyNotFound"]
        admin_CMD029["admin.CMD029"]
        admin_EVT021["admin.EVT021"]
        admin_CMD030["admin.CMD030"]
        admin_EVT022["admin.EVT022"]
        ...
        admin_CMD033["admin.CMD033"]
        admin_EVT024["admin.EVT024"]
        admin_QRY007["admin.QRY007"]
        admin_QRY008["admin.QRY008"]
        admin_QRY009["admin.QRY009"]
        admin_CMD034["admin.CMD034"]
        admin_EVT025["admin.EVT025"]
        admin_CMD035["admin.CMD035"]
        admin_EVT026["admin.EVT026"]
        admin_ERR009["SqlRequestNotFound"]
        admin_ERR010["SqlQueryForbidden"]
        admin_CMD001["admin.CMD001"]
        admin_EVT001["admin.EVT001"]
        admin_CMD002["admin.CMD002"]
        admin_EVT002["admin.EVT002"]
        ...
        admin_CMD008["admin.CMD008"]
        admin_EVT006["admin.EVT006"]
        admin_QRY001["admin.QRY001"]
        admin_QRY002["admin.QRY002"]
        admin_CMD009["admin.CMD009"]
        admin_EVT007["admin.EVT007"]
        admin_CMD010["admin.CMD010"]
        admin_EVT008["admin.EVT008"]
        ...
        admin_EVT009["admin.EVT009"]
        admin_CMD012["admin.CMD012"]
        admin_QRY003["admin.QRY003"]
        admin_CMD013["admin.CMD013"]
        admin_EVT010["admin.EVT010"]
        admin_CMD014["admin.CMD014"]
        admin_EVT011["admin.EVT011"]
        admin_QRY004["admin.QRY004"]
        admin_CMD015["admin.CMD015"]
        admin_EVT012["admin.EVT012"]
        admin_CMD016["admin.CMD016"]
        admin_EVT013["admin.EVT013"]
        ...
        admin_CMD019["admin.CMD019"]
        admin_CMD020["admin.CMD020"]
        admin_ERR001["EmployeeNotFound"]
        admin_ERR002["ProfileNotFound"]
        admin_ERR003["ProfileInUse"]
        admin_ERR004["EmployeeEmailNotUnique"]
        admin_ERR005["PasswordPolicyViolation"]
        catalog_CMD025["catalog.CMD025"]
        catalog_CMD026["catalog.CMD026"]
        catalog_CMD027["catalog.CMD027"]
        catalog_CMD028["catalog.CMD028"]
        catalog_CMD029["catalog.CMD029"]
        catalog_QRY005["catalog.QRY005"]
        catalog_QRY006["catalog.QRY006"]
        catalog_EVT009["catalog.EVT009"]
        catalog_EVT010["catalog.EVT010"]
        catalog_ERR004["CategoryNotFound"]
        catalog_ERR005["CategoryTreeDepthExceeded"]
        catalog_CMD030["catalog.CMD030"]
        catalog_CMD031["catalog.CMD031"]
        catalog_CMD032["catalog.CMD032"]
        catalog_CMD033["catalog.CMD033"]
        catalog_QRY007["catalog.QRY007"]
        catalog_QRY008["catalog.QRY008"]
        catalog_CMD011["catalog.CMD011"]
        catalog_CMD012["catalog.CMD012"]
        catalog_CMD013["catalog.CMD013"]
        catalog_CMD014["catalog.CMD014"]
        catalog_CMD015["catalog.CMD015"]
        catalog_QRY003["catalog.QRY003"]
        catalog_QRY004["catalog.QRY004"]
        catalog_EVT004["catalog.EVT004"]
        catalog_EVT005["catalog.EVT005"]
        catalog_CMD040["catalog.CMD040"]
        catalog_CMD041["catalog.CMD041"]
        ...
        catalog_CMD024["catalog.CMD024"]
        catalog_EVT007["catalog.EVT007"]
        catalog_ERR007["SpecificPriceConflict"]
        catalog_CMD001["catalog.CMD001"]
        catalog_CMD002["catalog.CMD002"]
        catalog_CMD003["catalog.CMD003"]
        catalog_CMD004["catalog.CMD004"]
        ...
        catalog_CMD009["catalog.CMD009"]
        catalog_CMD010["catalog.CMD010"]
        catalog_QRY001["catalog.QRY001"]
        catalog_QRY002["catalog.QRY002"]
        catalog_QRY009["catalog.QRY009"]
        catalog_EVT001["catalog.EVT001"]
        catalog_EVT002["catalog.EVT002"]
        catalog_EVT003["catalog.EVT003"]
        catalog_EVT008["catalog.EVT008"]
        catalog_ERR001["ProductNotFound"]
        catalog_ERR002["DuplicateSKU"]
        catalog_ERR003["InvalidProductType"]
        catalog_ERR006["ImageDimensionsTooSmall"]
        catalog_CMD034["catalog.CMD034"]
        catalog_CMD035["catalog.CMD035"]
        catalog_CMD036["catalog.CMD036"]
        catalog_CMD037["catalog.CMD037"]
        catalog_CMD038["catalog.CMD038"]
        catalog_CMD039["catalog.CMD039"]
        catalog_QRY010["catalog.QRY010"]
        catalog_QRY011["catalog.QRY011"]
        checkout_CMD001["checkout.CMD001"]
        checkout_CMD002["checkout.CMD002"]
        checkout_CMD003["checkout.CMD003"]
        checkout_CMD004["checkout.CMD004"]
        ...
        checkout_EVT002["checkout.EVT002"]
        checkout_EVT003["checkout.EVT003"]
        checkout_QRY001["checkout.QRY001"]
        checkout_QRY002["checkout.QRY002"]
        checkout_QRY003["checkout.QRY003"]
        checkout_ERR001["CartNotFound"]
        checkout_ERR002["CannotDeleteOrderedCart"]
        checkout_ERR003["CannotUpdateCart"]
        checkout_CMD009["checkout.CMD009"]
        checkout_CMD010["checkout.CMD010"]
        checkout_CMD011["checkout.CMD011"]
        checkout_CMD012["checkout.CMD012"]
        checkout_CMD013["checkout.CMD013"]
        checkout_EVT004["checkout.EVT004"]
        checkout_ERR004["MinimalQuantityNotMet"]
        checkout_ERR005["CartConstraintViolation"]
        checkout_CMD014["checkout.CMD014"]
        checkout_CMD015["checkout.CMD015"]
        checkout_QRY004["checkout.QRY004"]
        checkout_EVT005["checkout.EVT005"]
        checkout_EVT006["checkout.EVT006"]
        checkout_CMD016["checkout.CMD016"]
        checkout_CMD017["checkout.CMD017"]
        ...
        checkout_CMD019["checkout.CMD019"]
        checkout_CMD020["checkout.CMD020"]
        checkout_QRY005["checkout.QRY005"]
        checkout_QRY006["checkout.QRY006"]
        checkout_EVT007["checkout.EVT007"]
        checkout_EVT008["checkout.EVT008"]
        checkout_EVT009["checkout.EVT009"]
        checkout_ERR006["DiscountNotFound"]
        checkout_ERR007["InvalidDiscountConfiguration"]
        checkout_CMD021["checkout.CMD021"]
        checkout_CMD022["checkout.CMD022"]
        checkout_CMD023["checkout.CMD023"]
        checkout_QRY007["checkout.QRY007"]
        checkout_QRY008["checkout.QRY008"]
        checkout_EVT010["checkout.EVT010"]
        checkout_EVT011["checkout.EVT011"]
        checkout_EVT012["checkout.EVT012"]
        checkout_ERR008["CatalogPriceRuleNotFound"]
        content_CMD001["content.CMD001"]
        content_CMD002["content.CMD002"]
        content_CMD003["content.CMD003"]
        content_CMD004["content.CMD004"]
        ...
        content_QRY005["content.QRY005"]
        content_QRY006["content.QRY006"]
        content_ERR001["CmsPageNotFound"]
        content_ERR002["CmsPageCategoryNotFound"]
        content_ERR003["CannotDeleteCategoryWithChildren"]
        content_CMD019["content.CMD019"]
        content_CMD020["content.CMD020"]
        content_EVT015["content.EVT015"]
        content_EVT016["content.EVT016"]
        content_QRY007["content.QRY007"]
        content_QRY008["content.QRY008"]
        content_ERR007["MetaNotFound"]
        content_ERR008["DuplicateMetaPageName"]
        content_CMD013["content.CMD013"]
        content_CMD014["content.CMD014"]
        content_CMD015["content.CMD015"]
        content_CMD016["content.CMD016"]
        ...
        content_EVT013["content.EVT013"]
        content_EVT014["content.EVT014"]
        content_ERR004["ThemeNotFound"]
        content_ERR005["ThemeImportFailed"]
        content_ERR006["CannotDeleteActiveTheme"]
        customers_CMD012["customers.CMD012"]
        customers_CMD013["customers.CMD013"]
        customers_CMD014["customers.CMD014"]
        customers_CMD015["customers.CMD015"]
        customers_QRY009["customers.QRY009"]
        customers_QRY010["customers.QRY010"]
        customers_EVT007["customers.EVT007"]
        customers_EVT008["customers.EVT008"]
        customers_EVT009["customers.EVT009"]
        customers_ERR005["AddressNotFound"]
        customers_ERR006["InvalidAddressData"]
        customers_CMD001["customers.CMD001"]
        customers_CMD002["customers.CMD002"]
        customers_CMD003["customers.CMD003"]
        customers_CMD004["customers.CMD004"]
        ...
        customers_EVT003["customers.EVT003"]
        customers_EVT004["customers.EVT004"]
        customers_QRY001["customers.QRY001"]
        customers_QRY002["customers.QRY002"]
        customers_QRY003["customers.QRY003"]
        customers_QRY004["customers.QRY004"]
        customers_QRY005["customers.QRY005"]
        customers_QRY006["customers.QRY006"]
        customers_QRY007["customers.QRY007"]
        customers_ERR001["CustomerNotFound"]
        customers_ERR002["DuplicateCustomerEmail"]
        customers_ERR003["InvalidCustomerData"]
        customers_CMD009["customers.CMD009"]
        customers_CMD010["customers.CMD010"]
        customers_CMD011["customers.CMD011"]
        customers_QRY008["customers.QRY008"]
        customers_EVT005["customers.EVT005"]
        customers_EVT006["customers.EVT006"]
        customers_ERR004["CustomerGroupNotFound"]
        customers_CMD016["customers.CMD016"]
        customers_CMD017["customers.CMD017"]
        customers_CMD018["customers.CMD018"]
        customers_CMD019["customers.CMD019"]
        customers_QRY011["customers.QRY011"]
        customers_QRY012["customers.QRY012"]
        customers_EVT010["customers.EVT010"]
        customers_EVT011["customers.EVT011"]
        customers_EVT012["customers.EVT012"]
        customers_ERR007["CustomerThreadNotFound"]
        customers_CMD020["customers.CMD020"]
        customers_CMD021["customers.CMD021"]
        customers_CMD022["customers.CMD022"]
        customers_QRY013["customers.QRY013"]
        customers_EVT013["customers.EVT013"]
        customers_EVT014["customers.EVT014"]
        customers_ERR008["TitleNotFound"]
        international_CMD001["international.CMD001"]
        international_CMD002["international.CMD002"]
        international_CMD003["international.CMD003"]
        international_CMD004["international.CMD004"]
        ...
        international_EVT005["international.EVT005"]
        international_EVT006["international.EVT006"]
        international_QRY001["international.QRY001"]
        international_QRY002["international.QRY002"]
        international_QRY003["international.QRY003"]
        international_ERR001["CurrencyNotFound"]
        international_ERR002["CurrencyConstraintViolation"]
        international_CMD011["international.CMD011"]
        international_CMD012["international.CMD012"]
        international_CMD013["international.CMD013"]
        international_CMD014["international.CMD014"]
        ...
        international_EVT021["international.EVT021"]
        international_EVT022["international.EVT022"]
        international_QRY005["international.QRY005"]
        international_QRY006["international.QRY006"]
        international_QRY007["international.QRY007"]
        international_QRY008["international.QRY008"]
        international_ERR004["CountryNotFound"]
        international_ERR005["StateNotFound"]
        international_ERR006["ZoneNotFound"]
        international_CMD007["international.CMD007"]
        international_CMD008["international.CMD008"]
        international_CMD009["international.CMD009"]
        international_CMD010["international.CMD010"]
        ...
        international_EVT009["international.EVT009"]
        international_EVT010["international.EVT010"]
        international_QRY004["international.QRY004"]
        international_ERR003["LanguageNotFound"]
        international_CMD023["international.CMD023"]
        international_CMD024["international.CMD024"]
        international_CMD025["international.CMD025"]
        international_CMD026["international.CMD026"]
        ...
        international_EVT029["international.EVT029"]
        international_EVT030["international.EVT030"]
        international_QRY009["international.QRY009"]
        international_QRY010["international.QRY010"]
        international_ERR007["TaxNotFound"]
        international_ERR008["TaxRulesGroupNotFound"]
        international_ERR009["TaxRulesGroupConstraintViolation"]
        modules_CMD001["modules.CMD001"]
        modules_CMD002["modules.CMD002"]
        modules_CMD003["modules.CMD003"]
        modules_CMD004["modules.CMD004"]
        ...
        modules_QRY002["modules.QRY002"]
        modules_QRY003["modules.QRY003"]
        modules_ERR001["ModuleNotFound"]
        modules_ERR002["ModuleNotInstalled"]
        modules_ERR003["AlreadyInstalledModule"]
        modules_ERR004["ModuleAlreadyUpToDate"]
        modules_ERR005["HookNotFound"]
        orders_CMD017["orders.CMD017"]
        orders_CMD018["orders.CMD018"]
        orders_CMD019["orders.CMD019"]
        orders_EVT007["orders.EVT007"]
        orders_EVT008["orders.EVT008"]
        orders_ERR002["PaymentDeclined"]
        orders_ERR006["InvoiceAlreadyGenerated"]
        orders_CMD024["orders.CMD024"]
        orders_CMD025["orders.CMD025"]
        orders_CMD026["orders.CMD026"]
        orders_CMD027["orders.CMD027"]
        ...
        orders_CMD035["orders.CMD035"]
        orders_CMD036["orders.CMD036"]
        orders_QRY005["orders.QRY005"]
        orders_QRY006["orders.QRY006"]
        orders_CMD001["orders.CMD001"]
        orders_CMD004["orders.CMD004"]
        orders_CMD002["orders.CMD002"]
        orders_CMD005["orders.CMD005"]
        ...
        orders_EVT004["orders.EVT004"]
        orders_EVT005["orders.EVT005"]
        orders_QRY001["orders.QRY001"]
        orders_QRY002["orders.QRY002"]
        orders_QRY003["orders.QRY003"]
        orders_ERR003["OrderNotFound"]
        orders_ERR004["InvalidStateTransition"]
        orders_CMD020["orders.CMD020"]
        orders_CMD021["orders.CMD021"]
        orders_CMD022["orders.CMD022"]
        orders_EVT009["orders.EVT009"]
        ...
        orders_EVT003["orders.EVT003"]
        orders_EVT006["orders.EVT006"]
        orders_ERR005["RefundExceedsTotal"]
        orders_ERR001["InsufficientStock"]
        orders_CMD023["orders.CMD023"]
        orders_EVT010["orders.EVT010"]
        orders_QRY004["orders.QRY004"]
        orders_ERR007["ReturnWindowExpired"]
        shipping_CMD001["shipping.CMD001"]
        shipping_CMD002["shipping.CMD002"]
        shipping_CMD003["shipping.CMD003"]
        shipping_CMD004["shipping.CMD004"]
        ...
        shipping_EVT007["shipping.EVT007"]
        shipping_EVT008["shipping.EVT008"]
        shipping_QRY001["shipping.QRY001"]
        shipping_QRY002["shipping.QRY002"]
        shipping_QRY003["shipping.QRY003"]
        shipping_QRY004["shipping.QRY004"]
        shipping_ERR001["CarrierNotFound"]
        shipping_ERR002["CarrierConstraintViolation"]
        shipping_ERR003["CannotModifyCarrier"]
        shipping_CMD011["shipping.CMD011"]
        shipping_CMD012["shipping.CMD012"]
        shipping_CMD013["shipping.CMD013"]
        shipping_CMD014["shipping.CMD014"]
        ...
        shipping_EVT014["shipping.EVT014"]
        shipping_EVT015["shipping.EVT015"]
        shipping_QRY005["shipping.QRY005"]
        shipping_QRY006["shipping.QRY006"]
        shipping_QRY007["shipping.QRY007"]
        shipping_QRY008["shipping.QRY008"]
        shipping_QRY009["shipping.QRY009"]
        shipping_QRY010["shipping.QRY010"]
        shipping_QRY011["shipping.QRY011"]
        shipping_ERR004["ShipmentNotFound"]
        shipping_ERR005["CannotModifyShippedShipment"]
        shipping_ERR006["CannotModifyShipment"]
        shop_CMD001["shop.CMD001"]
        shop_EVT001["shop.EVT001"]
        shop_QRY001["shop.QRY001"]
        shop_QRY002["shop.QRY002"]
        shop_CMD002["shop.CMD002"]
        shop_EVT002["shop.EVT002"]
        shop_CMD003["shop.CMD003"]
        shop_EVT003["shop.EVT003"]
        ...
        shop_EVT009["shop.EVT009"]
        shop_CMD013["shop.CMD013"]
        shop_QRY005["shop.QRY005"]
        shop_QRY006["shop.QRY006"]
        shop_QRY007["shop.QRY007"]
        shop_CMD014["shop.CMD014"]
        shop_EVT010["shop.EVT010"]
        shop_CMD015["shop.CMD015"]
        shop_EVT011["shop.EVT011"]
        shop_CMD016["shop.CMD016"]
        shop_EVT012["shop.EVT012"]
        shop_QRY008["shop.QRY008"]
        shop_CMD017["shop.CMD017"]
        shop_EVT013["shop.EVT013"]
        shop_QRY009["shop.QRY009"]
        shop_CMD018["shop.CMD018"]
        shop_EVT014["shop.EVT014"]
        shop_QRY010["shop.QRY010"]
        shop_ERR001["LogoExtensionNotSupported"]
        shop_ERR002["SearchEngineNotFound"]
        shop_ERR003["AliasNotFound"]
    end
    subgraph design_ui["design.ui"]
        admin_SCR001["Grid of employees with status, profile, email, and bulk action controls."]
        admin_SCR002["Employee creation/edit form with profile selection and shop association."]
        admin_SCR003["Permission matrix editor for tab and module access per profile."]
        admin_SCR004["API client list with create, edit, delete, and secret rotation controls."]
        admin_SCR005["Active session list with delete and bulk cleanup controls."]
        admin_SCR006["Saved SQL query list with add, edit, execute, and export controls."]
        admin_UAC001["Add Employee"]
        admin_UAC002["Toggle Employee Status"]
        admin_UAC003["Save Tab Permissions"]
        admin_UAC004["Rotate API Secret"]
        admin_UAC005["Clear Outdated Sessions"]
        admin_UAC006["Execute SQL Query"]
        admin_UNV001["Navigate to employee creation or edit form."]
        admin_UNV002["Navigate to permission matrix editor."]
        checkout_SCR001["Back-office view of a cart session with products, totals, applied discounts, and customer info."]
        checkout_SCR002["Paginated list of all discounts with status filters (active, scheduled, expired), search, and bulk actions."]
        checkout_SCR003["Form for creating and editing discounts — conditions, actions, validity, usage limits, and product rule groups."]
        checkout_SCR004["List of catalog price rules with bulk delete and status management."]
        checkout_UAC001["Add Product to Cart"]
        checkout_UAC002["Apply Cart Rule"]
        checkout_UAC003["Create Discount"]
        checkout_UAC004["Save Discount"]
        checkout_UAC005["Bulk Delete Discounts"]
        checkout_UNV001["Navigate to discount edit form."]
        checkout_UNV002["Navigate from cart to discount list."]
        content_SCR001["Paginated grid of CMS pages with title, category, status, and bulk action controls."]
        content_SCR002["CMS page add/edit form with localized title, content editor, SEO metadata, category selector, and display toggle."]
        content_SCR003["Tree view of CMS page categories with breadcrumb navigation, status, and bulk actions."]
        content_SCR004["CMS page category add/edit form with localized name, parent selector, SEO metadata, and display toggle."]
        content_SCR005["Theme list with active indicator, import controls, and theme action buttons (enable, delete, reset, RTL)."]
        content_SCR006["Meta entry list with page name, URL rewrite, and localized title/description management."]
        content_UAC001["Add CMS Page"]
        content_UAC002["Bulk Toggle CMS Page Status"]
        content_UAC003["Add CMS Category"]
        content_UAC004["Import Theme"]
        content_UAC005["Enable Theme"]
        content_UAC006["Add Meta Entry"]
        content_UNV001["Navigate to CMS page editor."]
        content_UNV002["Navigate to CMS category editor."]
        customers_SCR001["Paginated list of customer accounts with search, filter by group, and bulk enable/disable/delete actions."]
        customers_SCR002["Full customer profile with personal info, addresses, order history, carts, and group assignment."]
        customers_SCR003["Service thread view with message history, customer context, and reply form."]
        customers_SCR004["Address creation/edit form with country-specific required field indicators."]
        customers_UAC001["Add Customer"]
        customers_UAC002["Edit Customer"]
        customers_UAC003["Reply to Thread"]
        customers_UAC004["Bulk Enable/Disable"]
        customers_UNV001["Navigate to customer detail."]
        customers_UNV002["Navigate to address form."]
        international_SCR001["Paginated list of currencies with ISO code, exchange rate, status, and bulk actions."]
        international_SCR002["Currency add/edit form with ISO code, exchange rate, precision, localized names/symbols."]
        international_SCR003["Paginated list of languages with ISO code, locale, RTL flag, and status."]
        international_SCR004["List of geographic zones with status and assigned country/state counts."]
        international_SCR005["Paginated list of countries with ISO code, zone assignment, and status."]
        international_SCR006["Tax rules group edit form with matrix of zone/country tax rule bindings."]
        international_UAC001["Add Currency"]
        international_UAC002["Refresh Exchange Rates"]
        international_UAC003["Save Tax Rules Group"]
        international_UAC004["Add Country"]
        international_UNV001["Navigate to currency configuration."]
        international_UNV002["Navigate to zone list filtered by country selection."]
        modules_SCR001["Grid of modules with status indicators, bulk actions, and lifecycle controls (install, enable, disable, upgrade)."]
        modules_SCR002["Module upload form for importing module packages from file archives."]
        modules_SCR003["Hook list with active status toggles. Shows registered modules per hook."]
        modules_UAC001["Install Module"]
        modules_UAC002["Toggle Module Status"]
        modules_UAC003["Upload Module"]
        modules_UAC004["Toggle Hook Status"]
        modules_UNV001["Navigate to module upload form."]
        orders_SCR001["Back-office order list with search, filters, and bulk actions."]
        orders_SCR002["Single order view with line items, payment, shipping, and action buttons."]
        orders_SCR003["Back-office screen for managing merchandise returns and credit slips."]
        orders_UAC001["Filter Orders"]
        orders_UAC002["Cancel Order"]
        orders_UAC003["Process Refund"]
        orders_UAC004["Generate Invoice"]
        orders_UAC005["Add Payment"]
        orders_UAC006["Update Return Status"]
        orders_UNV001["Navigate from order list to order detail."]
        orders_UNV002["Navigate from order detail to return management."]
        shipping_SCR001["Paginated list of carriers with status indicators, shipping method, and bulk enable/disable/delete actions."]
        shipping_SCR002["Multi-step carrier form: general settings, zones, ranges, dimensional constraints, and tax rule assignment."]
        shipping_SCR003["List of shipments for a specific order with product assignments, tracking numbers, and split/merge actions."]
        shipping_SCR004["Single shipment view with assigned products, carrier info, tracking number, and edit/split controls."]
        shipping_UAC001["Add Carrier"]
        shipping_UAC002["Bulk Toggle Carrier Status"]
        shipping_UAC003["Save Carrier"]
        shipping_UAC004["Create Shipment"]
        shipping_UAC005["Split Shipment"]
        shipping_UAC006["Merge Products"]
        shipping_UNV001["Navigate to carrier configuration."]
        shipping_UNV002["Navigate to shipment detail."]
        shop_SCR001["Logo upload form for header, invoice, mail, and favicon images."]
        shop_SCR002["Grid of physical store locations with status toggles and bulk actions."]
        shop_SCR003["List of SEO referrer search engines with CRUD controls."]
        shop_SCR004["Search term alias management with add, edit, and bulk delete."]
        shop_SCR005["Contact Us form department list with add and edit controls."]
        shop_UAC001["Upload Logos"]
        shop_UAC002["Toggle Store Status"]
        shop_UAC003["Add Search Alias"]
        shop_UNV001["Navigate from SEO referrers to search aliases."]
    end
    subgraph design_models["design.models"]
        MDL800["Request body for creating a new back-office employee with profile-based RBAC and multi-store shop association."]
        MDL801["Employee details for the back-office edit form. Includes profile assignment, language, default page, and multi-store shop association."]
        MDL802["Request body for creating a new RBAC access control profile with localized names."]
        MDL803["Profile details for the back-office edit form. Includes localized names and the profile identifier."]
        MDL804["Request body for registering a new OAuth2 API client for the PrestaShop Admin API."]
        MDL805["API client details for the back-office edit form. One of only 2 Admin API resources exposed in core — the other is the ApiClient list endpoint."]
        MDL806["Request body for creating a legacy XML webservice access key with resource-level permissions."]
        MDL807["Webservice key details for the back-office edit form. Legacy XML API access configuration."]
        MDL011["Request body for creating a new category."]
        MDL012["Partial update payload for an existing category."]
        MDL013["Full category representation for editing. Includes tree position, names, SEO, and cover image."]
        MDL014["Recursive tree node for category hierarchy display."]
        MDL015["Request body for creating a new attribute group for product combinations."]
        MDL016["Full attribute group with its values for editing."]
        MDL017["Request body for creating a new product feature."]
        MDL018["Full feature with its values for product form display."]
        MDL007["Request body for generating product combinations from selected attribute groups and values."]
        MDL008["Partial update payload for a combination's price impact, stock, reference, EAN, weight."]
        MDL009["Full combination representation for editing form."]
        MDL010["Lightweight combination summary for paginated lists."]
        MDL001["Request body for creating a new product. Minimal fields — product starts in draft status."]
        MDL002["Partial update payload for product. All fields optional except productId. Covers name, description, prices, SEO, options, shipping."]
        MDL003["Full product representation for editing. Composite model with nested sub-objects for prices, stock, SEO, shipping, and options."]
        MDL004["Lightweight product summary for paginated list views and search results."]
        MDL005["Product pricing subsection — base price, tax, ecotax, wholesale, unit price."]
        MDL006["Product stock subsection — quantity, minimum order, low stock alert, availability labels."]
        MDL019["Request body for creating a specific price rule on a product."]
        MDL020["Request body for registering a new manufacturer/brand."]
        MDL021["Request body for registering a new product supplier."]
        MDL200["Request body for adding a product to a cart. Creates cart session if none exists. Supports product variants (combinations) and customizations."]
        MDL201["Request body for changing the quantity of an existing product in the cart."]
        MDL202["Full cart representation for back-office editing. Composite model with product lines, computed totals, applied rules, and delivery configuration."]
        MDL203["Single cart line item with product details, variant, quantity, and computed price."]
        MDL204["Request body for creating a discount cart rule. Covers voucher codes, automatic discounts, free shipping, and BOGO offers with conditions and usage limits."]
        MDL205["Full cart rule / discount representation for the editing form. Includes all conditions, actions, and usage statistics."]
        MDL206["Request body for creating a catalog price rule. Bulk price reductions for product selections based on quantity thresholds, customer groups, or date ranges."]
        MDL207["Full catalog price rule representation for the editing form. Includes conditions, reduction settings, and applicable product filters."]
        MDL600["Request body for creating a new CMS page with localized title, content, SEO metadata, friendly URL, and category assignment."]
        MDL601["CMS page representation for back-office editing. Includes all localized fields, SEO metadata, category assignment, and display status."]
        MDL602["Request body for creating a new CMS page category with localized name, description, SEO metadata, friendly URL, and parent assignment."]
        MDL603["CMS page category representation for back-office editing. Includes localized fields, hierarchy info, SEO metadata, and shop association."]
        MDL604["Theme representation for back-office listing and management. Exposes theme identity, version, active status, and preview information."]
        MDL605["SEO metadata entry for a page type. Maps internal page names to localized titles, meta descriptions, and URL rewrite rules."]
        MDL300["Request body for registering a new customer account with profile, group assignment, and shop association."]
        MDL301["Request body for updating an existing customer's profile data. All fields except customerId are optional — only provided fields are updated."]
        MDL302["Full customer profile for back-office editing form. Includes identity, group assignments, newsletter preference, and account metadata."]
        MDL303["Request body for creating a new customer address for delivery or invoicing."]
        MDL304["Customer address representation for the back-office editing form."]
        MDL305["Lightweight customer summary for paginated back-office list views."]
        MDL306["Customer group configuration for the back-office editing form."]
        MDL307["Customer service thread with full message history for back-office viewing."]
        MDL500["Request body for creating a new currency (official or unofficial) with ISO code, exchange rate, precision, and localized names."]
        MDL501["Currency representation for back-office editing. Exposes the full attribute set including localized names, symbols, transformations, and exchange rate."]
        MDL502["Request body for creating a new tax rate definition with localized name and percentage."]
        MDL503["Tax rules group representation for back-office editing. Includes the group name, status, and associated tax rule bindings."]
        MDL504["Request body for creating a new country with ISO code, zone assignment, address configuration, and zip code format."]
        MDL505["Country representation for back-office editing. Includes ISO code, zone, address format, zip code configuration, and tax display settings."]
        MDL506["Language representation for back-office viewing and editing. Exposes the full attribute set including locale, RTL support, and date format."]
        MDL507["Geographic zone representation for back-office editing. Zones group countries and states for shipping cost calculation and tax rule assignment."]
        MDL508["Request body for creating a new store language with ISO code, locale, name, RTL flag, and flag image."]
        MDL509["State/province/region representation for back-office editing. States have their own zone assignment enabling granular shipping and tax configuration within a country."]
        MDL700["Module representation for back-office listing and management. Exposes identity, version, lifecycle state, and configuration access."]
        MDL701["Request body for uploading a module package. The source is a file path or URL pointing to the module archive (zip)."]
        MDL702["Hook representation for back-office management. Exposes hook identity, status, and registered module positions."]
        MDL100["Request body for placing a new order from a validated cart."]
        MDL101["Request body for changing an order's status."]
        MDL102["Request body for changing the delivery address on an order."]
        MDL107["Request body for manually recording a payment on an order."]
        MDL108["Request body for issuing a partial refund on specific order lines."]
        MDL103["Comprehensive order representation for back-office viewing. Composite model with 14+ sub-objects covering products, payments, history, documents, and messaging."]
        MDL104["Lightweight order summary for paginated list views."]
        MDL105["Single order line item — product, quantity, unit price, and line total."]
        MDL106["Order pricing summary — products total, shipping, discounts, tax, and grand total."]
        MDL400["Request body for creating a new carrier with delivery configuration, zone assignments, dimensional constraints, and shop associations."]
        MDL401["Full carrier configuration for the back-office editing form including zones, ranges, dimensional constraints, and versioning metadata."]
        MDL402["Lightweight carrier summary for paginated back-office list views."]
        MDL403["Full shipment details for back-office viewing including carrier, tracking, products, and delivery status."]
        MDL404["Computed shipping cost for a carrier in a given context (zone, weight/price bracket, tax rule)."]
        MDL405["Zone-based shipping configuration — defines cost ranges for a carrier within a specific delivery zone."]
        MDL900["Request body for uploading store branding images. Each file type has extension validation — logos accept jpg/gif/png, favicon accepts ico only."]
        MDL901["Shop details for multi-store management. Represents a single storefront instance in PrestaShop's multi-store architecture."]
        MDL902["Request body for creating a physical retail store location with address, coordinates, and operating hours."]
        MDL903["Physical store location details for the back-office edit form."]
        MDL904["Request body for registering a new SEO referrer search engine for analytics tracking."]
        MDL905["SEO referrer search engine details for the back-office edit form."]
        MDL906["Request body for creating a search term alias mapping to improve storefront search relevance."]
        MDL907["Contact department details for the back-office edit form. Represents a 'Contact Us' form category."]
    end
    subgraph governance_motivation["governance.motivation"]
        admin_G001["Secure RBAC"]
        admin_G002["API-first integration"]
        admin_G003["Session security"]
        admin_G004["SQL self-service"]
        admin_NG001["No LDAP/Active Directory integration for employee authentication"]
        admin_R001["Privilege escalation risk"]
        admin_R002["SQL injection risk"]
        admin_R003["Secret leakage risk"]
        admin_A001["PHP 8.1+ is the minimum supported runtime"]
        admin_T001["admin.T001"]
        admin_INQ001["API rate limiting gap"]
        admin_INQ002["Legacy configuration CQRS gap"]
        catalog_G001["Fast product search at scale"]
        catalog_G002["Rich faceted product filtering"]
        catalog_G003["Responsive catalog back-office"]
        catalog_G004["Full catalog API coverage"]
        catalog_G005["Enterprise-scale bulk import"]
        catalog_NG001["No built-in B2B tiered/volume pricing engine"]
        catalog_NG002["No AI-powered product recommendations in core"]
        catalog_R001["Search index staleness after bulk ops"]
        catalog_R002["Image storage cost at scale"]
        catalog_R003["Multi-store product data drift"]
        catalog_R004["Combinatorial explosion"]
        catalog_A001["Elasticsearch cluster can be managed as a shared service across PrestaShop instances"]
        catalog_A002["Elasticsearch is available for stores with >10,000 products"]
        catalog_T001["catalog.T001"]
        catalog_INQ001["GraphQL for headless catalog"]
        catalog_INQ002["Async bulk import with progress"]
        checkout_G001["Above-average checkout conversion rate"]
        checkout_G002["Measurable promotion campaign effectiveness"]
        checkout_G003["Fast cart rule evaluation"]
        checkout_NG001["No cryptocurrency or BNPL payment processing in core"]
        checkout_R001["Flash sale checkout latency"]
        checkout_R002["Discount stacking exploitation"]
        checkout_R003["Cart rule evaluation scalability"]
        checkout_A001["Payment module authors follow the PaymentModule interface contract"]
        checkout_T001["checkout.T001"]
        checkout_INQ001["Cart rule evaluation architecture"]
        checkout_INQ002["Headless cart real-time updates"]
        content_G001["CMS content management efficiency"]
        content_G002["SEO metadata coverage"]
        content_G003["Brand consistency via themes"]
        content_NG001["No visual page builder or WYSIWYG block editor in core"]
        content_R001["SEO URL breakage risk"]
        content_R002["Theme upgrade incompatibility"]
        content_R003["Category tree corruption"]
        content_T001["content.T001"]
        content_INQ001["Headless CMS API"]
        customers_G001["High registration completion rate"]
        customers_G002["High address data quality"]
        customers_G003["Fast customer service response"]
        customers_G004["GDPR compliance"]
        customers_NG001["No built-in SSO/SAML/OIDC for customer authentication"]
        customers_R001["Email spoofing risk"]
        customers_R002["International address validation"]
        customers_R003["PII data breach risk"]
        customers_T001["customers.T001"]
        customers_INQ001["Customer segmentation API"]
        customers_INQ002["Automated GDPR deletion"]
        international_G001["Accurate multi-currency pricing"]
        international_G002["Tax calculation accuracy"]
        international_G003["Localization completeness"]
        international_NG001["No automatic regulatory compliance monitoring"]
        international_R001["Exchange rate staleness"]
        international_R002["Tax rule coverage gaps"]
        international_R003["Geographic restructuring cascade"]
        international_A001["Currency exchange rates from ECB or similar free feeds remain available"]
        international_INQ001["Automated exchange rate scheduling"]
        international_INQ002["EU VAT MOSS support"]
        modules_G001["Module lifecycle reliability"]
        modules_G002["Safe module upgrades"]
        modules_G003["Controllable hooks"]
        modules_NG001["No containerized or sandboxed module isolation"]
        modules_R001["Module incompatibility risk"]
        modules_R002["Module security risk"]
        modules_A001["Third-party modules may hook into any public class or method"]
        modules_T001["modules.T001"]
        modules_INQ001["Hook position management gap"]
        modules_INQ002["Module dependency resolution"]
        orders_G001["Sub-second checkout transition"]
        orders_G002["Multi-currency order support"]
        orders_G003["Order error rate < 0.1%"]
        orders_G004["EU VAT invoice compliance"]
        orders_NG001["PrestaShop will not implement its own payment gateway"]
        orders_NG002["No real-time inventory sync with physical POS"]
        orders_R001["FO/BO cart total mismatch"]
        orders_R002["Stale exchange rates"]
        orders_R003["Concurrent stock over-sell"]
        orders_R004["Custom order state dead-end risk"]
        orders_A001["PrestaShop will continue to support shared hosting (no container-only requirement)"]
        orders_A002["Stripe and PayPal modules will adopt the new Cart Price API within 6 months"]
        orders_A003["EU VAT rates will not change more than twice per year"]
        orders_T001["orders.T001"]
        orders_T002["orders.T002"]
        orders_INQ001["Cart rules engine migration feasibility"]
        orders_INQ002["EU exchange rate display regulation"]
        orders_INQ003["Smarty vs Twig performance for checkout"]
        shipping_G001["Accurate shipping costs"]
        shipping_G002["Full zone coverage"]
        shipping_G003["Efficient order fulfillment"]
        shipping_NG001["No fleet management or driver dispatch"]
        shipping_R001["Zone gap risk"]
        shipping_R002["Range miscalculation risk"]
        shipping_R003["Shipment integrity after dispatch"]
        shipping_INQ001["Multi-carrier rate comparison"]
        shop_G001["Store branding consistency"]
        shop_G002["Search alias discoverability"]
        shop_G003["SEO referrer analytics"]
        shop_NG001["No marketplace/multi-vendor capabilities"]
        shop_R001["Stale search index"]
        shop_R002["Multi-store CQRS gaps"]
        shop_A001["MySQL/MariaDB is the only supported RDBMS"]
        shop_T001["shop.T001"]
        shop_INQ001["Multi-store CQRS gap"]
        shop_INQ002["Store CRUD gap"]
    end
    subgraph design_quality["design.quality"]
        admin_KPI001["Failed Login Rate"]
        admin_KPI002["API Client Uptime"]
        admin_SLO001["Authentication Latency SLO"]
        catalog_KPI001["Search Result Relevance"]
        catalog_KPI002["Catalog Completeness"]
        catalog_KPI003["API Coverage"]
        catalog_SLO001["Search API Latency"]
        catalog_SLO002["Product Save Latency"]
        catalog_SLO003["Bulk Import Throughput"]
        catalog_RES001["Search Index Recovery"]
        checkout_KPI001["Cart-to-Order Conversion Rate"]
        checkout_KPI002["Discount Calculation Accuracy"]
        checkout_KPI003["Active Discount Campaign Count"]
        checkout_SLO001["Add-to-Cart Latency"]
        checkout_SLO002["Cart Rule Evaluation Latency"]
        checkout_SLO003["Discount CRUD Response Time"]
        checkout_SEC001["Voucher Code Brute-Force Protection"]
        checkout_CMP001["Promotion Transparency"]
        content_KPI001["SEO Metadata Coverage"]
        content_KPI002["CMS Content Completeness"]
        content_KPI003["Theme Activation Success Rate"]
        content_SLO001["CMS Page Load Time"]
        content_SLO002["Theme Switch Availability"]
        customers_KPI001["Registration Success Rate"]
        customers_KPI002["Address Validation Pass Rate"]
        customers_KPI003["Guest-to-Customer Conversion Rate"]
        customers_SLO001["Customer Service First Response Time"]
        customers_SLO002["Registration API Latency"]
        customers_SEC001["PII Encryption at Rest"]
        customers_CMP001["GDPR Data Subject Rights"]
        international_KPI001["Exchange Rate Freshness"]
        international_KPI002["Tax Rule Coverage"]
        international_KPI003["Localization Completeness"]
        international_SLO001["Tax Calculation Accuracy"]
        international_SLO002["Exchange Rate Refresh Latency"]
        modules_KPI001["Module Install Success Rate"]
        modules_KPI002["Module Upgrade Success Rate"]
        modules_SLO001["Module Lifecycle Operation Latency"]
        orders_MT001["Order Processing Latency"]
        orders_MT002["Refund Processing Time"]
        KPI001["Order Error Rate"]
        KPI002["Checkout-to-Confirmation Time"]
        KPI003["Invoice Generation Compliance Rate"]
        SLO001["Order API Availability"]
        SLO002["Order Query Response Time"]
        SLO003["Refund Processing SLO"]
        orders_SEC001["Order Data Access Control"]
        orders_SEC002["Refund Authorization"]
        orders_CMP001["GDPR Order Data Retention"]
        orders_CMP002["EU Consumer Rights — 14-day Return Window"]
        shipping_KPI001["Shipping Cost Accuracy"]
        shipping_KPI002["Zone Coverage Completeness"]
        shipping_KPI003["Shipment Fulfillment Rate"]
        shipping_SLO001["Carrier Configuration API Latency"]
        shipping_SLO002["Shipment Creation Latency"]
        shop_KPI001["Search Index Freshness"]
        shop_KPI002["Search Alias Coverage"]
        shop_SLO001["Search Indexation Latency"]
    end
    subgraph design_rules["design.rules"]
        admin_SR001["Employee requires profile assignment"]
        admin_VR001["Employee email uniqueness"]
        admin_VR002["Password strength policy"]
        admin_VR003["Profile deletion requires no assigned employees"]
        admin_VR004["Permission matrix consistency"]
        admin_VR005["API client scope validation"]
        admin_VR006["SQL query safety guard"]
        catalog_SR001["Product must have valid type configuration"]
        catalog_SR002["Category tree maximum depth"]
        catalog_SR003["Root category cannot be deleted"]
        catalog_CR001["Product lifecycle transitions"]
        catalog_CR002["Product type determines combination eligibility"]
        catalog_VR001["Product image dimensions"]
        catalog_VR002["Product deletion safety check"]
        catalog_VR003["Specific price reduction range"]
        catalog_VR004["Combination attribute uniqueness"]
        catalog_VR005["Manufacturer name uniqueness"]
        checkout_SR001["Cart item quantity must be positive"]
        checkout_SR002["Discount reduction value must be valid"]
        checkout_CR001["Cart status transitions"]
        checkout_CR002["Discount stacking priority"]
        checkout_DR001["Cart total derivation"]
        checkout_VR001["Discount date range validity"]
        checkout_VR002["Discount minimum order amount"]
        checkout_VR003["Discount usage limit enforcement"]
        checkout_VR004["Catalog price rule quantity threshold"]
        checkout_VR005["Cannot delete ordered cart"]
        checkout_TR001["Empty to active on product addition"]
        checkout_TR002["Active to checkout-started on checkout initiation"]
        checkout_TR003["Checkout-started to completed on order placement"]
        checkout_TR004["Active to abandoned on timeout"]
        checkout_TR005["Checkout-started to abandoned on timeout"]
        content_SR001["CMS Category Tree Acyclicity"]
        content_VR001["CMS Page Requires Category"]
        content_VR002["Meta Fields No Special Characters"]
        content_VR003["Category Deletion Requires Empty Subtree"]
        content_VR004["Theme Activation Exclusivity"]
        content_VR005["Active Theme Cannot Be Deleted"]
        content_VR006["Meta Page Name Uniqueness"]
        content_TR001["Theme Enable Deactivates Current"]
        customers_SR001["One customer account per email per shop"]
        customers_CR001["Customer service thread status transitions"]
        customers_VR001["Customer email must be valid"]
        customers_VR002["Password policy"]
        customers_VR003["Guest conversion prerequisites"]
        customers_VR004["Customer group discount range"]
        customers_VR005["Address required fields per country"]
        customers_VR006["GDPR right to erasure"]
        customers_TR001["Guest to active on conversion"]
        customers_TR002["Active to inactive on disable"]
        customers_TR003["Inactive to active on enable"]
        international_SR001["Unique ISO currency code per shop"]
        international_VR001["Currency ISO code format"]
        international_VR002["Default currency cannot be deleted"]
        international_VR003["Language ISO code uniqueness"]
        international_VR004["Default language cannot be deleted"]
        international_VR005["Country ISO code format"]
        international_VR006["Tax rate must be non-negative"]
        international_VR007["Exchange rate must be positive"]
        international_VR008["Tax rule binding uniqueness"]
        modules_SR001["Module Must Be Installed for Lifecycle Operations"]
        modules_VR001["Module Technical Name Non-Empty"]
        modules_VR002["Reset Requires Installed Module"]
        modules_VR003["Upgrade Requires Installed Module with Available Update"]
        modules_TR001["Module Lifecycle State Machine"]
        orders_SR001["Order must have at least one line"]
        orders_SR002["Invoice requires paid status"]
        orders_CR001["Order status transitions"]
        orders_DR001["Estimated delivery from shipping method"]
        orders_EQ001["Order total equals sum of line totals"]
        orders_VR001["Shipping address required for physical products"]
        orders_VR002["Payment amount must not exceed order total"]
        orders_VR003["Return eligibility window"]
        orders_VR004["Partial refund constraints"]
        orders_TR001["Order state machine transitions"]
        shipping_SR001["Carrier requires at least one zone"]
        shipping_VR001["Carrier name constraints"]
        shipping_VR002["Shipping method must be valid"]
        shipping_VR003["Free shipping disables additional handling fee"]
        shipping_VR004["Ranges must not overlap within a zone"]
        shipping_VR005["Range values must be non-negative"]
        shipping_VR006["Shipment requires valid order and carrier"]
        shipping_VR007["Split shipment requires valid quantities"]
        shipping_VR008["Merge requires compatible shipments"]
        shipping_TR001["Shipped shipment becomes immutable"]
        shop_VR001["Logo file extension validation"]
        shop_VR002["Alias search term non-empty"]
        shop_VR003["Contact email format"]
        shop_VR004["Search engine server uniqueness"]
    end
    subgraph design_story["design.story"]
        admin_STR001["Employee Onboarding"]
        admin_STR002["API Integration Setup"]
        admin_STR003["Security Session Cleanup"]
        admin_US001["create new employee accounts with appropriate profile and shop access"]
        admin_US002["manage access control profiles and their permission matrices"]
        admin_US003["set up and manage Admin API clients for third-party integrations"]
        admin_US004["monitor and clear active sessions during security incidents"]
        admin_US005["create and execute saved SQL queries for reporting"]
        admin_UC001["Onboard Employee"]
        admin_UC002["Configure API Client"]
        catalog_STR001["Add a product to catalog"]
        catalog_STR002["Manage product variants"]
        catalog_STR003["Organize category hierarchy"]
        catalog_US001["CategoryManager creates a product."]
        catalog_US002["CategoryManager bulk imports products."]
        catalog_US003["Shopper searches the catalog."]
        catalog_US004["CategoryManager generates combinations for a product."]
        catalog_US005["CategoryManager manages category tree."]
        catalog_US006["CategoryManager manages product pricing rules."]
        catalog_US007["CategoryManager manages product gallery."]
        catalog_US008["Merchant reviews product detail."]
        catalog_UC001["CategoryManager adds a new product to the catalog."]
        catalog_UC002["Shopper searches the catalog with keywords and filters."]
        catalog_UC003["CategoryManager generates combinations and configures variant details."]
        checkout_STR001["Shopper cart journey"]
        checkout_STR002["Discount campaign setup"]
        checkout_US001["add a product to my cart"]
        checkout_US002["remove an item from my cart"]
        checkout_US003["apply a voucher code to my cart"]
        checkout_US004["create a discount campaign with conditions and usage limits"]
        checkout_US005["duplicate an existing discount as a campaign template"]
        checkout_US006["configure catalog price rules for wholesale customers"]
        checkout_US007["create and send a pre-built cart to a customer"]
        checkout_UC001["Shopper adds a product to the shopping cart."]
        checkout_UC002["Back-office operator creates and configures a cart for order creation."]
        checkout_UC003["Shopper applies a voucher code to receive a discount on their cart."]
        checkout_UC004["Marketing manager creates a promotional discount with conditions and limits."]
        content_STR001["CMS Page Publishing"]
        content_STR002["Theme Activation"]
        content_US001["create and publish a CMS page with SEO metadata"]
        content_US002["organize CMS pages into a hierarchical category structure"]
        content_US003["import and activate a new storefront theme"]
        content_US004["configure SEO metadata for all page types"]
        content_US005["reset theme layouts after a major theme update"]
        content_US006["generate email templates for a theme in a specific language"]
        content_UC001["Publish CMS Page"]
        content_UC002["Switch Store Theme"]
        customers_STR001["Customer account lifecycle"]
        customers_STR002["Customer service interaction"]
        customers_US001["register a customer account"]
        customers_US002["add and manage my delivery addresses"]
        customers_US003["convert a guest account to a registered customer"]
        customers_US004["reply to a customer service thread"]
        customers_US005["set up a B2B customer group with wholesale pricing"]
        customers_US006["request deletion of my personal data"]
        customers_UC001["New customer creates an account with email, password, and basic profile."]
        customers_UC002["Customer adds, edits, or deletes delivery and invoice addresses."]
        customers_UC003["Agent views customer thread, replies, and resolves the issue."]
        international_STR001["Multi-Currency Store Setup"]
        international_STR002["Tax Rules Configuration"]
        international_US001["add and configure currencies for an international store"]
        international_US002["refresh exchange rates from an external provider"]
        international_US003["configure store languages"]
        international_US004["manage geographic zones, countries, and states"]
        international_US005["configure tax rates and tax rules groups"]
        international_US006["set up EU VAT rules across multiple countries"]
        international_UC001["Configure Multi-Currency Store"]
        international_UC002["Set Up EU VAT Tax Rules"]
        modules_STR001["Module Installation & Activation"]
        modules_STR002["Module Troubleshooting"]
        modules_US001["install a new module to extend store functionality"]
        modules_US002["disable a problematic module quickly without uninstalling"]
        modules_US003["upgrade installed modules to their latest versions"]
        modules_US004["manage hook activation to control extension points"]
        modules_UC001["Install Module"]
        modules_UC002["Troubleshoot Module"]
        orders_STR001["Place an order"]
        orders_STR002["Cancel and refund"]
        orders_STR003["Manage order products"]
        orders_STR004["Generate invoice and record payment"]
        orders_STR005["Process return and credit slip"]
        orders_US001["Shopper places an order."]
        orders_US002["Merchant cancels an order."]
        orders_US003["Administrator processes refund."]
        orders_US004["Merchant views order history."]
        orders_US005["Merchant generates invoice."]
        orders_US006["Merchant records offline payment."]
        orders_UC001["Shopper completes checkout and creates an order."]
        orders_UC002["Merchant cancels an unshipped order."]
        orders_UC003["Merchant reviews filtered order history for business insights."]
        orders_UC004["Administrator processes a merchandise return and generates a credit slip."]
        shipping_STR001["Carrier Configuration"]
        shipping_STR002["Order Shipment Fulfillment"]
        shipping_US001["create a new carrier with zone and range configuration"]
        shipping_US002["enable or disable carriers"]
        shipping_US003["configure free shipping for a carrier"]
        shipping_US004["create a shipment for an order and assign products"]
        shipping_US005["split a shipment into multiple parcels"]
        shipping_US006["merge products from multiple shipments into one"]
        shipping_UC001["Configure Carrier"]
        shipping_UC002["Manage Order Shipments"]
        shop_STR001["Store Branding Setup"]
        shop_STR002["Search Alias Configuration"]
        shop_US001["upload and manage store branding images (logos and favicon)"]
        shop_US002["manage search term aliases to map customer search variants to canonical terms"]
        shop_US003["configure SEO referrer search engines for analytics tracking"]
        shop_US004["manage 'Contact Us' form departments"]
        shop_UC001["Configure Store Branding"]
    end
    subgraph governance_tests["governance.tests"]
        admin_TC001["Creating an employee with valid data and a profile assignment succeeds."]
        admin_TC002["Updating the tab permission matrix for a profile applies the new permissions."]
        admin_TC003["Creating an API client with valid name, scopes, and lifetime succeeds."]
        admin_TC004["Automated clearing of expired employee sessions succeeds."]
        admin_TC005["Executing a valid read-only SQL query returns a result set."]
        admin_EC001["Bulk delete should protect the last super-admin employee from deletion."]
        admin_EC002["Secret rotation should not immediately invalidate active tokens."]
        admin_ER001["Creating an employee with an already-used email is rejected."]
        admin_ER002["Deleting a profile that still has employees assigned is rejected."]
        admin_ER003["Executing a SQL query containing write operations is rejected."]
        catalog_TC001["Valid product data creates product with draft status successfully."]
        catalog_TC002["Search by product name returns matching results within SLO."]
        catalog_TC003["Generating combinations for a valid product creates all permutations."]
        catalog_TC004["Creating a category within valid depth succeeds."]
        catalog_TC005["Creating a 20% discount specific price succeeds."]
        catalog_EC001["Attempting to create a combination with existing attribute values."]
        catalog_EC002["Creating a category that exceeds maximum nesting depth."]
        catalog_EC003["Attempting to generate too many combinations triggers a warning or rejection."]
        catalog_ER001["Attempting to upload a product image smaller than minimum dimensions."]
        catalog_ER002["Attempting to delete a product that has pending orders."]
        catalog_ER003["Attempting to create a specific price with 150% reduction."]
        checkout_TC001["Add an in-stock product to an empty cart."]
        checkout_TC002["Apply a valid voucher code to a cart meeting all conditions."]
        checkout_TC003["Create a percentage discount with date range and usage limits."]
        checkout_TC004["Create a B2B quantity discount for bulk purchases."]
        checkout_EC001["Attempt to apply a voucher whose validity period has passed."]
        checkout_EC002["Customer attempts to use a voucher they have already exhausted."]
        checkout_ER001["Attempt to delete a cart that was already converted to an order."]
        checkout_ER002["Attempt to create a discount with end date before start date."]
        checkout_ER003["Voucher requires EUR 50 minimum but cart total is EUR 30."]
        content_TC001["Verify that a CMS page can be created with all required fields and assigned to a category."]
        content_TC002["Verify that a CMS page category can be created within the tree hierarchy."]
        content_TC003["Verify that a theme can be imported and activated, deactivating the previous theme."]
        content_TC004["Verify that a meta entry can be created for a page type with localized titles and URL rewrites."]
        content_TC005["Verify that theme layouts can be reset to their default configuration."]
        content_EC001["Verify that setting a category's parent to one of its descendants is rejected."]
        content_EC002["Verify that enabling the already-active theme does not cause errors."]
        content_ER001["Verify that deleting a category containing CMS pages is rejected."]
        content_ER002["Verify that the currently active theme cannot be deleted."]
        content_ER003["Verify that creating a meta entry with an existing page name is rejected."]
        customers_TC001["Register a new customer with valid email and password."]
        customers_TC002["Add a delivery address with all required fields for France."]
        customers_TC003["Convert a guest account to registered customer."]
        customers_TC004["Agent replies to an open service thread."]
        customers_EC001["Attempt to register with an email already in use."]
        customers_EC002["Submit address without postcode for a country that requires it."]
        customers_ER001["Attempt to register with a password shorter than minimum."]
        customers_ER002["Convert guest whose email is already used by a registered customer."]
        customers_ER003["Attempt to delete a customer ID that does not exist."]
        international_TC001["Create a new official currency with valid ISO code and exchange rate."]
        international_TC002["Refresh all exchange rates from external provider."]
        international_TC003["Create a tax rules group and assign a tax rate to a zone."]
        international_TC004["Set up different VAT rates per EU country within a tax rules group."]
        international_EC001["Attempt to delete the store's default (reference) currency."]
        international_EC002["Attempt to add a second tax rule for the same zone+country in a group."]
        international_ER001["Attempt to create a currency with an invalid (non-3-letter) ISO code."]
        international_ER002["Attempt to create a tax rate with a negative percentage."]
        international_ER003["Attempt to assign a country to a zone that does not exist."]
        modules_TC001["Verify that a module can be installed by technical name and transitions to installed_enabled state."]
        modules_TC002["Verify that a module can be disabled and re-enabled without losing configuration."]
        modules_TC003["Verify that an installed module can be upgraded to a newer version."]
        modules_TC004["Verify that a hook can be disabled and re-enabled."]
        modules_EC001["Verify that resetting a module with keepData=true preserves configuration."]
        modules_EC002["Verify that upgrading a module already at latest version raises ModuleAlreadyUpToDate."]
        modules_ER001["Verify that installing a module that is already installed raises AlreadyInstalledModule."]
        modules_ER002["Verify that enabling/disabling a non-installed module raises ModuleNotInstalled."]
        orders_TC001["Valid cart, sufficient stock, payment succeeds."]
        orders_TC002["Order in payment-accepted status, not yet shipped."]
        orders_TC003["Order with payment-accepted status, no existing invoice."]
        orders_TC004["Manually add a bank transfer payment to an order."]
        orders_EC001["Cart item exceeds available stock during checkout."]
        orders_EC002["Partial refund for the exact remaining refundable amount after a previous partial refund."]
        orders_ER001["Payment gateway does not respond within SLA timeout."]
        orders_ER002["Customer attempts to return an order after the 14-day return window."]
        orders_ER003["Attempt to transition a refunded order back to processing."]
        shipping_TC001["Create a new carrier with valid configuration including zones, ranges, and shipping method."]
        shipping_TC002["Enable free shipping on a carrier, bypassing range-based pricing."]
        shipping_TC003["Create a new shipment for an existing order with a valid carrier and product."]
        shipping_TC004["Split a shipment, moving some products to a new shipment with a different carrier."]
        shipping_EC001["Attempt to set carrier ranges with overlapping brackets within the same zone."]
        shipping_EC002["Attempt to edit tracking number on a shipment that has already been dispatched."]
        shipping_ER001["Attempt to create a carrier with an empty zone list."]
        shipping_ER002["Attempt to edit a shipment that does not exist."]
        shipping_ER003["Attempt to set a range with a negative from value."]
        shop_TC001["Uploading valid logo images succeeds and updates store branding."]
        shop_TC002["Creating a new search term alias mapping succeeds."]
        shop_TC003["Registering a new search engine referrer succeeds."]
        shop_TC004["Triggering a full search index rebuild completes successfully."]
        shop_EC001["Search index rebuild should not disrupt active customer searches."]
        shop_ER001["Uploading a logo with an invalid file extension is rejected."]
        shop_ER002["Creating an alias with an empty search term is rejected."]
    end
    subgraph governance_capability["governance.capability"]
        CAP013["Content Management"]
        CAP014["Module Ecosystem"]
        CAP015["Employee & Access Management"]
        CAP016["API & Integration Platform"]
        CAP017["Multi-Store Management"]
        CAP005["Catalog Management"]
        CAP010["Shipping & Delivery"]
        CAP011["Multi-Currency & Tax"]
        CAP012["Localization"]
        CAP018["Search & Discovery"]
        CAP001["Order Management"]
        CAP002["Cart Calculation"]
        CAP003["Checkout Flow"]
        CAP004["Stock Reservation"]
        CAP006["Customer Notifications"]
        CAP007["Customer Account Management"]
        CAP008["Address Management"]
        CAP009["Customer Service"]
    end
    subgraph governance_decisions["governance.decisions"]
        D001["Use domain events to coordinate order state changes across services."]
        D002["Use Elasticsearch as read-optimized search index instead of MySQL LIKE queries."]
        D003["Delegate all payment card handling to certified gateway modules (Stripe, PayPal, Mollie)."]
        D004["Store cart state server-side (database) rather than client-side (cookies/localStorage)."]
        D005["Adopt Command-Query Responsibility Segregation across all domain aggregates for clear write/read separation."]
        D006["Migrate back-office from legacy controllers to Symfony framework with Twig templates."]
        D007["Introduce a modern REST API for back-office operations with OAuth2 authentication, replacing legacy webservice."]
        D008["Support headless commerce by exposing all storefront operations through APIs, enabling decoupled frontends."]
    end
    subgraph governance_org["governance.org"]
        PRT001["PrestaShop SA"]
        DPT001["Engineering"]
        DPT002["Product & Design"]
        DPT003["Platform & Ecosystem"]
        TM001["Order Platform Team"]
        TM002["Catalog Team"]
        TM003["Checkout & Payments Team"]
        TM004["Customer Experience Team"]
        TM005["Logistics Team"]
        TM006["International & Localization Team"]
        TM007["Content & Design Team"]
        TM008["Module Ecosystem Team"]
        TM009["Platform Security Team"]
        TM010["Core Platform Team"]
    end
    subgraph design_arch["design.arch"]
        PrestaShop["PrestaShop v9 monolith with CQRS domain layer and Symfony framework."]
        Catalog["Product catalog — CRUD, variants, media, categories, attributes, suppliers, search indexing."]
        CatalogService["REST API for product and category management."]
        CatalogService_openapi["CatalogService.openapi"]
        CatalogService_asyncapi["CatalogService.asyncapi"]
        Orders["Order lifecycle — placement, state management, cancellation, refund, invoice, returns, credit slips."]
        OrderService["REST API for order commands and queries."]
        OrderService_openapi["OrderService.openapi"]
        OrderService_asyncapi["OrderService.asyncapi"]
        Checkout["Cart management, checkout flow, cart rules, promotions, payment orchestration."]
        CheckoutService["REST API for cart operations and payment initiation."]
        CheckoutService_openapi["CheckoutService.openapi"]
        CheckoutService_asyncapi["CheckoutService.asyncapi"]
        Customers["Customer accounts, addresses, customer service messaging, titles."]
        CustomerService["REST API for customer account and address management."]
        CustomerService_openapi["CustomerService.openapi"]
        Shipping["Carrier configuration, shipping cost calculation, shipment tracking."]
        ShippingService["REST API for carrier management and shipping cost calculation."]
        ShippingService_openapi["ShippingService.openapi"]
        International["Currencies, countries, zones, languages, tax rules — localization backbone."]
        InternationalService["REST API for currency, tax, country, and language management."]
        InternationalService_openapi["InternationalService.openapi"]
        Content["CMS pages, page categories, themes, email templates, SEO meta."]
        ContentService["REST API for CMS page and theme management."]
        ContentService_openapi["ContentService.openapi"]
        Modules["Module lifecycle, hook system, module marketplace integration."]
        ModuleManager["Module lifecycle orchestrator with hook execution pipeline."]
        ModuleManager_openapi["ModuleManager.openapi"]
        Admin["Employee accounts, profiles, security, API clients, configuration."]
        AdminService["REST API for employee, security, and configuration management."]
        AdminService_openapi["AdminService.openapi"]
        AdminService_security_schemes["AdminService.security_schemes"]
        Shop["Multi-store configuration, physical stores, contacts, search, aliases."]
        ShopService["REST API for multi-store and shop configuration."]
        ShopService_openapi["ShopService.openapi"]
        ExternalApiConsumers["External systems consuming PrestaShop Admin API via OAuth2."]
        AdminApiClient["External API consumer using PrestaShop Admin REST API with OAuth2 authentication."]
    ...
    subgraph governance_roadmap["governance.roadmap"]
        MS001["MVP — Cart & Checkout"]
        MS002["Catalog v2 — Search & Filters"]
        MS003["Scale — Async Orders & Inventory"]
        MS004["International & Multi-Store"]
        MS005["API-First & Headless"]
    end
    subgraph governance_value_stream["governance.value-stream"]
        VS001["Shop & Buy"]
        VS002["Sell & Fulfill"]
        VS003["Configure & Scale"]
    end
    ...
    subgraph code["code"]
        src_Core_Domain_ApiClient_Command_AddApiClientCommand_php["src/Core/Domain/ApiClient/Command/AddApiClientCommand.php"]
        src_Core_Domain_ApiClient_Command_ForceApiClientSecretCommand_php["src/Core/Domain/ApiClient/Command/ForceApiClientSecretCommand.php"]
        src_Core_Domain_ApiClient_Command_GenerateApiClientSecretCommand_php["src/Core/Domain/ApiClient/Command/GenerateApiClientSecretCommand.php"]
        src_Core_Domain_Webservice_Command_AddWebserviceKeyCommand_php["src/Core/Domain/Webservice/Command/AddWebserviceKeyCommand.php"]
        src_Core_Domain_Webservice_Command_EditWebserviceKeyCommand_php["src/Core/Domain/Webservice/Command/EditWebserviceKeyCommand.php"]
        src_Core_Domain_SqlManagement_Command_AddSqlRequestCommand_php["src/Core/Domain/SqlManagement/Command/AddSqlRequestCommand.php"]
        src_Core_Domain_SqlManagement_Command_EditSqlRequestCommand_php["src/Core/Domain/SqlManagement/Command/EditSqlRequestCommand.php"]
        src_Core_Domain_SqlManagement_Command_SaveSqlRequestSettingsCommand_php["src/Core/Domain/SqlManagement/Command/SaveSqlRequestSettingsCommand.php"]
        src_Core_Domain_Configuration_Command_SwitchDebugModeCommand_php["src/Core/Domain/Configuration/Command/SwitchDebugModeCommand.php"]
        src_Core_Domain_Configuration_ShopConfigurationInterface_php["src/Core/Domain/Configuration/ShopConfigurationInterface.php"]
        src_Core_Domain_Tab_Command_UpdateTabStatusByClassNameCommand_php["src/Core/Domain/Tab/Command/UpdateTabStatusByClassNameCommand.php"]
        src_Core_Domain_Employee_Command_AddEmployeeCommand_php["src/Core/Domain/Employee/Command/AddEmployeeCommand.php"]
        src_Core_Domain_Employee_ValueObject_FirstName_php["src/Core/Domain/Employee/ValueObject/FirstName.php"]
        src_Core_Domain_Employee_ValueObject_LastName_php["src/Core/Domain/Employee/ValueObject/LastName.php"]
        src_Core_Domain_Employee_ValueObject_Password_php["src/Core/Domain/Employee/ValueObject/Password.php"]
        src_Core_Domain_Profile_Command_AddProfileCommand_php["src/Core/Domain/Profile/Command/AddProfileCommand.php"]
        src_Core_Domain_Profile_Command_AbstractProfileCommand_php["src/Core/Domain/Profile/Command/AbstractProfileCommand.php"]
        src_Core_Domain_Profile_ProfileSettings_php["src/Core/Domain/Profile/ProfileSettings.php"]
        src_Core_Domain_Profile_Permission_Command_UpdateTabPermissionsCommand_php["src/Core/Domain/Profile/Permission/Command/UpdateTabPermissionsCommand.php"]
        src_Core_Domain_Profile_Permission_Command_UpdateModulePermissionsCommand_php["src/Core/Domain/Profile/Permission/Command/UpdateModulePermissionsCommand.php"]
        src_Core_Domain_Security_Command_DeleteEmployeeSessionCommand_php["src/Core/Domain/Security/Command/DeleteEmployeeSessionCommand.php"]
        src_Core_Domain_Security_Command_DeleteCustomerSessionCommand_php["src/Core/Domain/Security/Command/DeleteCustomerSessionCommand.php"]
        src_Core_Domain_Security_Command_ClearOutdatedEmployeeSessionCommand_php["src/Core/Domain/Security/Command/ClearOutdatedEmployeeSessionCommand.php"]
        src_Core_Domain_Category_["src/Core/Domain/Category/"]
        src_Core_Domain_AttributeGroup_["src/Core/Domain/AttributeGroup/"]
        src_Core_Domain_Feature_["src/Core/Domain/Feature/"]
        src_Core_Domain_ImageSettings_["src/Core/Domain/ImageSettings/"]
        src_Core_Domain_Product_["src/Core/Domain/Product/"]
        https___github_com_PrestaShop_docs_blob_9_x_development_architecture_domain_references_product__index_md["https://github.com/PrestaShop/docs/blob/9.x/development/architecture/domain/references/product/_index.md"]
        src_Core_Domain_Combination_["src/Core/Domain/Combination/"]
        src_Core_Domain_Product_Image_["src/Core/Domain/Product/Image/"]
        src_Core_Domain_Product_SpecificPrice_["src/Core/Domain/Product/SpecificPrice/"]
        src_Core_Domain_Tag_["src/Core/Domain/Tag/"]
        src_Core_Domain_Attachment_["src/Core/Domain/Attachment/"]
        src_Core_Domain_Manufacturer_["src/Core/Domain/Manufacturer/"]
        src_Core_Domain_Supplier_["src/Core/Domain/Supplier/"]
        src_Core_Domain_Cart_ValueObject_CartId_php["src/Core/Domain/Cart/ValueObject/CartId.php"]
        src_Core_Domain_Cart_CartStatus_php["src/Core/Domain/Cart/CartStatus.php"]
        src_Core_Domain_Cart_Command_AddProductToCartCommand_php["src/Core/Domain/Cart/Command/AddProductToCartCommand.php"]
        src_Core_Domain_CartRule_ValueObject_CartRuleId_php["src/Core/Domain/CartRule/ValueObject/CartRuleId.php"]
        src_Core_Domain_CartRule_Query_SearchCartRules_php["src/Core/Domain/CartRule/Query/SearchCartRules.php"]
        src_Core_Domain_Cart_CartAddressType_php["src/Core/Domain/Cart/CartAddressType.php"]
        src_Core_Domain_Discount_ValueObject_DiscountId_php["src/Core/Domain/Discount/ValueObject/DiscountId.php"]
        src_Core_Domain_Discount_DiscountSettings_php["src/Core/Domain/Discount/DiscountSettings.php"]
        src_Core_Domain_Discount_Command_AddDiscountCommand_php["src/Core/Domain/Discount/Command/AddDiscountCommand.php"]
        src_Core_Domain_Discount_ProductRuleGroup_php["src/Core/Domain/Discount/ProductRuleGroup.php"]
        src_Core_Domain_Discount_ProductRuleGroupType_php["src/Core/Domain/Discount/ProductRuleGroupType.php"]
        src_Core_Domain_Discount_ValueObject_DiscountType_php["src/Core/Domain/Discount/ValueObject/DiscountType.php"]
        src_Core_Domain_CatalogPriceRule_Command_AddCatalogPriceRuleCommand_php["src/Core/Domain/CatalogPriceRule/Command/AddCatalogPriceRuleCommand.php"]
        src_Core_Domain_CatalogPriceRule_Command_EditCatalogPriceRuleCommand_php["src/Core/Domain/CatalogPriceRule/Command/EditCatalogPriceRuleCommand.php"]
        src_Core_Domain_CmsPage_Command_AddCmsPageCommand_php["src/Core/Domain/CmsPage/Command/AddCmsPageCommand.php"]
        src_Core_Domain_CmsPage_ValueObject_CmsPageId_php["src/Core/Domain/CmsPage/ValueObject/CmsPageId.php"]
        src_Core_Domain_CmsPageCategory_Command_AddCmsPageCategoryCommand_php["src/Core/Domain/CmsPageCategory/Command/AddCmsPageCategoryCommand.php"]
        src_Core_Domain_CmsPageCategory_ValueObject_CmsPageCategoryId_php["src/Core/Domain/CmsPageCategory/ValueObject/CmsPageCategoryId.php"]
        src_Core_Domain_Meta_Command_AddMetaCommand_php["src/Core/Domain/Meta/Command/AddMetaCommand.php"]
        src_Core_Domain_Meta_Command_AbstractMetaCommand_php["src/Core/Domain/Meta/Command/AbstractMetaCommand.php"]
        src_Core_Domain_Meta_ValueObject_MetaId_php["src/Core/Domain/Meta/ValueObject/MetaId.php"]
        src_Core_Domain_Theme_Command_EnableThemeCommand_php["src/Core/Domain/Theme/Command/EnableThemeCommand.php"]
        src_Core_Domain_Theme_ValueObject_ThemeName_php["src/Core/Domain/Theme/ValueObject/ThemeName.php"]
        src_Core_Domain_Theme_ValueObject_ThemeImportSource_php["src/Core/Domain/Theme/ValueObject/ThemeImportSource.php"]
        src_Core_Domain_Address_Command_AddCustomerAddressCommand_php["src/Core/Domain/Address/Command/AddCustomerAddressCommand.php"]
        src_Core_Domain_Address_AddressSettings_php["src/Core/Domain/Address/AddressSettings.php"]
        src_Core_Domain_CustomerService_Command_ReplyToCustomerThreadCommand_php["src/Core/Domain/CustomerService/Command/ReplyToCustomerThreadCommand.php"]
        src_Core_Domain_Customer_Command_AddCustomerCommand_php["src/Core/Domain/Customer/Command/AddCustomerCommand.php"]
        src_Core_Domain_Customer_Command_EditCustomerCommand_php["src/Core/Domain/Customer/Command/EditCustomerCommand.php"]
        src_Core_Domain_Customer_Group_Command_AddCustomerGroupCommand_php["src/Core/Domain/Customer/Group/Command/AddCustomerGroupCommand.php"]
        src_Core_Domain_Title_Command_AddTitleCommand_php["src/Core/Domain/Title/Command/AddTitleCommand.php"]
        src_Core_Domain_Country_Command_AddCountryCommand_php["src/Core/Domain/Country/Command/AddCountryCommand.php"]
        src_Core_Domain_Country_ValueObject_CountryZipCodeFormat_php["src/Core/Domain/Country/ValueObject/CountryZipCodeFormat.php"]
        src_Core_Domain_State_Command_AddStateCommand_php["src/Core/Domain/State/Command/AddStateCommand.php"]
        src_Core_Domain_State_Command_EditStateCommand_php["src/Core/Domain/State/Command/EditStateCommand.php"]
        src_Core_Domain_Zone_Command_AddZoneCommand_php["src/Core/Domain/Zone/Command/AddZoneCommand.php"]
        src_Core_Domain_Zone_Command_EditZoneCommand_php["src/Core/Domain/Zone/Command/EditZoneCommand.php"]
        src_Core_Domain_Currency_Command_AbstractAddCurrencyCommand_php["src/Core/Domain/Currency/Command/AbstractAddCurrencyCommand.php"]
        src_Core_Domain_Currency_ValueObject_AlphaIsoCode_php["src/Core/Domain/Currency/ValueObject/AlphaIsoCode.php"]
        src_Core_Domain_Currency_ValueObject_ExchangeRate_php["src/Core/Domain/Currency/ValueObject/ExchangeRate.php"]
        src_Core_Domain_Currency_ValueObject_Precision_php["src/Core/Domain/Currency/ValueObject/Precision.php"]
        src_Core_Domain_Language_Command_AddLanguageCommand_php["src/Core/Domain/Language/Command/AddLanguageCommand.php"]
        src_Core_Domain_Language_Command_EditLanguageCommand_php["src/Core/Domain/Language/Command/EditLanguageCommand.php"]
        src_Core_Domain_Tax_Command_AddTaxCommand_php["src/Core/Domain/Tax/Command/AddTaxCommand.php"]
        src_Core_Domain_Tax_Command_EditTaxCommand_php["src/Core/Domain/Tax/Command/EditTaxCommand.php"]
        src_Core_Domain_TaxRulesGroup_Command_AddTaxRulesGroupCommand_php["src/Core/Domain/TaxRulesGroup/Command/AddTaxRulesGroupCommand.php"]
        src_Core_Domain_TaxRulesGroup_Command_EditTaxRulesGroupCommand_php["src/Core/Domain/TaxRulesGroup/Command/EditTaxRulesGroupCommand.php"]
        src_Core_Domain_TaxRulesGroup_ValueObject_TaxRulesGroupId_php["src/Core/Domain/TaxRulesGroup/ValueObject/TaxRulesGroupId.php"]
        src_Core_Domain_Module_Command_InstallModuleCommand_php["src/Core/Domain/Module/Command/InstallModuleCommand.php"]
        src_Core_Domain_Module_ValueObject_ModuleTechnicalName_php["src/Core/Domain/Module/ValueObject/ModuleTechnicalName.php"]
        src_Core_Domain_Module_ValueObject_ModuleId_php["src/Core/Domain/Module/ValueObject/ModuleId.php"]
        src_Core_Domain_Module_QueryResult_ModuleInfos_php["src/Core/Domain/Module/QueryResult/ModuleInfos.php"]
        src_Core_Domain_Hook_Command_UpdateHookStatusCommand_php["src/Core/Domain/Hook/Command/UpdateHookStatusCommand.php"]
        src_Core_Domain_Hook_ValueObject_HookId_php["src/Core/Domain/Hook/ValueObject/HookId.php"]
        src_Core_Domain_Hook_QueryResult_Hook_php["src/Core/Domain/Hook/QueryResult/Hook.php"]
        src_Core_Domain_OrderState_["src/Core/Domain/OrderState/"]
        classes_order_OrderState_php["classes/order/OrderState.php"]
        src_Core_Domain_OrderMessage_["src/Core/Domain/OrderMessage/"]
        src_Core_Domain_Order_["src/Core/Domain/Order/"]
        classes_order_Order_php["classes/order/Order.php"]
        classes_order_OrderDetail_php["classes/order/OrderDetail.php"]
        classes_order_OrderInvoice_php["classes/order/OrderInvoice.php"]
        classes_order_OrderPayment_php["classes/order/OrderPayment.php"]
        src_Core_Domain_OrderReturn_["src/Core/Domain/OrderReturn/"]
        classes_order_OrderReturn_php["classes/order/OrderReturn.php"]
        src_Core_Domain_OrderReturnState_["src/Core/Domain/OrderReturnState/"]
        classes_order_OrderReturnState_php["classes/order/OrderReturnState.php"]
        classes_order_OrderSlip_php["classes/order/OrderSlip.php"]
        src_Core_Domain_Carrier_Command_AddCarrierCommand_php["src/Core/Domain/Carrier/Command/AddCarrierCommand.php"]
        src_Core_Domain_Carrier_ValueObject_CarrierId_php["src/Core/Domain/Carrier/ValueObject/CarrierId.php"]
        src_Core_Domain_Carrier_ValueObject_CarrierReferenceId_php["src/Core/Domain/Carrier/ValueObject/CarrierReferenceId.php"]
        src_Core_Domain_Carrier_ValueObject_CarrierRangeZone_php["src/Core/Domain/Carrier/ValueObject/CarrierRangeZone.php"]
        src_Core_Domain_Carrier_ValueObject_CarrierRangePrice_php["src/Core/Domain/Carrier/ValueObject/CarrierRangePrice.php"]
        src_Core_Domain_Carrier_ValueObject_CarrierRangesCollection_php["src/Core/Domain/Carrier/ValueObject/CarrierRangesCollection.php"]
        src_Core_Domain_Carrier_Command_SetCarrierTaxRuleGroupCommand_php["src/Core/Domain/Carrier/Command/SetCarrierTaxRuleGroupCommand.php"]
        src_Core_Domain_Carrier_ValueObject_ShippingMethod_php["src/Core/Domain/Carrier/ValueObject/ShippingMethod.php"]
        src_Core_Domain_Carrier_ValueObject_OutOfRangeBehavior_php["src/Core/Domain/Carrier/ValueObject/OutOfRangeBehavior.php"]
        src_Core_Domain_Shipment_ValueObject_ShipmentId_php["src/Core/Domain/Shipment/ValueObject/ShipmentId.php"]
        src_Core_Domain_Shipment_Command_CreateShipment_php["src/Core/Domain/Shipment/Command/CreateShipment.php"]
        src_Core_Domain_Shipment_ValueObject_OrderDetailId_php["src/Core/Domain/Shipment/ValueObject/OrderDetailId.php"]
        src_Core_Domain_Shipment_ValueObject_OrderDetailQuantity_php["src/Core/Domain/Shipment/ValueObject/OrderDetailQuantity.php"]
        src_Core_Domain_Shop_Command_UploadLogosCommand_php["src/Core/Domain/Shop/Command/UploadLogosCommand.php"]
        src_Core_Domain_Shop_DTO_ShopLogoSettings_php["src/Core/Domain/Shop/DTO/ShopLogoSettings.php"]
        src_Core_Domain_Store_Command_DeleteStoreCommand_php["src/Core/Domain/Store/Command/DeleteStoreCommand.php"]
        src_Core_Domain_Store_Command_ToggleStoreStatusCommand_php["src/Core/Domain/Store/Command/ToggleStoreStatusCommand.php"]
        src_Core_Domain_SearchEngine_Command_AddSearchEngineCommand_php["src/Core/Domain/SearchEngine/Command/AddSearchEngineCommand.php"]
        src_Core_Domain_SearchEngine_Command_EditSearchEngineCommand_php["src/Core/Domain/SearchEngine/Command/EditSearchEngineCommand.php"]
        src_Core_Domain_Alias_Command_AddSearchTermAliasesCommand_php["src/Core/Domain/Alias/Command/AddSearchTermAliasesCommand.php"]
        src_Core_Domain_Alias_Command_UpdateSearchTermAliasesCommand_php["src/Core/Domain/Alias/Command/UpdateSearchTermAliasesCommand.php"]
        src_Core_Domain_Search_Command_SearchIndexationCommand_php["src/Core/Domain/Search/Command/SearchIndexationCommand.php"]
        src_Core_Domain_Contact_Command_AddContactCommand_php["src/Core/Domain/Contact/Command/AddContactCommand.php"]
        src_Core_Domain_Contact_Command_EditContactCommand_php["src/Core/Domain/Contact/Command/EditContactCommand.php"]
        src_Core_Domain_Contact_Command_AbstractContactCommand_php["src/Core/Domain/Contact/Command/AbstractContactCommand.php"]
        src_Core_Domain_Notification_Command_UpdateEmployeeNotificationLastElementCommand_php["src/Core/Domain/Notification/Command/UpdateEmployeeNotificationLastElementCommand.php"]
        src_Core_Domain_ShowcaseCard_Command_CloseShowcaseCardCommand_php["src/Core/Domain/ShowcaseCard/Command/CloseShowcaseCardCommand.php"]
        src_Core_Domain_ApiClient_Command_EditApiClientCommand_php["src/Core/Domain/ApiClient/Command/EditApiClientCommand.php"]
        src_Core_Domain_ApiClient_Command_DeleteApiClientCommand_php["src/Core/Domain/ApiClient/Command/DeleteApiClientCommand.php"]
        src_Core_Domain_ApiClient_Query_GetApiClientForEditing_php["src/Core/Domain/ApiClient/Query/GetApiClientForEditing.php"]
        src_Core_Domain_Webservice_Command_DeleteWebserviceKeyCommand_php["src/Core/Domain/Webservice/Command/DeleteWebserviceKeyCommand.php"]
        src_Core_Domain_Webservice_Command_BulkDeleteWebserviceKeyCommand_php["src/Core/Domain/Webservice/Command/BulkDeleteWebserviceKeyCommand.php"]
        src_Core_Domain_Webservice_Query_GetWebserviceKeyForEditing_php["src/Core/Domain/Webservice/Query/GetWebserviceKeyForEditing.php"]
        src_Core_Domain_SqlManagement_Command_DeleteSqlRequestCommand_php["src/Core/Domain/SqlManagement/Command/DeleteSqlRequestCommand.php"]
        src_Core_Domain_SqlManagement_Command_BulkDeleteSqlRequestCommand_php["src/Core/Domain/SqlManagement/Command/BulkDeleteSqlRequestCommand.php"]
        src_Core_Domain_SqlManagement_Query_GetSqlRequestForEditing_php["src/Core/Domain/SqlManagement/Query/GetSqlRequestForEditing.php"]
        src_Core_Domain_SqlManagement_Query_GetSqlRequestExecutionResult_php["src/Core/Domain/SqlManagement/Query/GetSqlRequestExecutionResult.php"]
        src_Core_Domain_SqlManagement_Query_GetSqlRequestSettings_php["src/Core/Domain/SqlManagement/Query/GetSqlRequestSettings.php"]
        src_Core_Domain_Employee_CommandHandler_AddEmployeeHandler_php["src/Core/Domain/Employee/CommandHandler/AddEmployeeHandler.php"]
        src_Core_Domain_Employee_Command_EditEmployeeCommand_php["src/Core/Domain/Employee/Command/EditEmployeeCommand.php"]
        src_Core_Domain_Employee_Command_DeleteEmployeeCommand_php["src/Core/Domain/Employee/Command/DeleteEmployeeCommand.php"]
        src_Core_Domain_Employee_Command_ToggleEmployeeStatusCommand_php["src/Core/Domain/Employee/Command/ToggleEmployeeStatusCommand.php"]
        src_Core_Domain_Employee_Command_BulkUpdateEmployeeStatusCommand_php["src/Core/Domain/Employee/Command/BulkUpdateEmployeeStatusCommand.php"]
        src_Core_Domain_Employee_Command_BulkDeleteEmployeeCommand_php["src/Core/Domain/Employee/Command/BulkDeleteEmployeeCommand.php"]
        src_Core_Domain_Employee_Command_SendEmployeePasswordResetEmailCommand_php["src/Core/Domain/Employee/Command/SendEmployeePasswordResetEmailCommand.php"]
        src_Core_Domain_Employee_Command_ResetEmployeePasswordCommand_php["src/Core/Domain/Employee/Command/ResetEmployeePasswordCommand.php"]
        src_Core_Domain_Employee_Query_GetEmployeeForEditing_php["src/Core/Domain/Employee/Query/GetEmployeeForEditing.php"]
        src_Core_Domain_Employee_Query_GetEmployeeEmailById_php["src/Core/Domain/Employee/Query/GetEmployeeEmailById.php"]
        src_Core_Domain_Profile_Command_EditProfileCommand_php["src/Core/Domain/Profile/Command/EditProfileCommand.php"]
        src_Core_Domain_Profile_Command_DeleteProfileCommand_php["src/Core/Domain/Profile/Command/DeleteProfileCommand.php"]
        src_Core_Domain_Profile_Command_BulkDeleteProfileCommand_php["src/Core/Domain/Profile/Command/BulkDeleteProfileCommand.php"]
        src_Core_Domain_Profile_Query_GetProfileForEditing_php["src/Core/Domain/Profile/Query/GetProfileForEditing.php"]
        src_Core_Domain_Profile_Permission_Query_GetPermissionsForConfiguration_php["src/Core/Domain/Profile/Permission/Query/GetPermissionsForConfiguration.php"]
        src_Core_Domain_Security_Command_BulkDeleteEmployeeSessionsCommand_php["src/Core/Domain/Security/Command/BulkDeleteEmployeeSessionsCommand.php"]
        src_Core_Domain_Security_Command_BulkDeleteCustomerSessionsCommand_php["src/Core/Domain/Security/Command/BulkDeleteCustomerSessionsCommand.php"]
        src_Core_Domain_Security_Command_ClearOutdatedCustomerSessionCommand_php["src/Core/Domain/Security/Command/ClearOutdatedCustomerSessionCommand.php"]
        src_Core_Domain_Category_Command_AddCategoryCommand_php["src/Core/Domain/Category/Command/AddCategoryCommand.php"]
        src_Core_Domain_Feature_Command_AddFeatureCommand_php["src/Core/Domain/Feature/Command/AddFeatureCommand.php"]
        src_Core_Domain_AttributeGroup_Command_AddAttributeGroupCommand_php["src/Core/Domain/AttributeGroup/Command/AddAttributeGroupCommand.php"]
        src_Core_Domain_Combination_Command_GenerateProductCombinationsCommand_php["src/Core/Domain/Combination/Command/GenerateProductCombinationsCommand.php"]
        src_Core_Domain_Combination_Command_UpdateCombinationCommand_php["src/Core/Domain/Combination/Command/UpdateCombinationCommand.php"]
        src_Core_Domain_Combination_Query_GetCombinationListQuery_php["src/Core/Domain/Combination/Query/GetCombinationListQuery.php"]
        src_Core_Domain_ImageSettings_Command_AddImageTypeCommand_php["src/Core/Domain/ImageSettings/Command/AddImageTypeCommand.php"]
        src_Core_Domain_Product_Image_Command_AddProductImageCommand_php["src/Core/Domain/Product/Image/Command/AddProductImageCommand.php"]
        src_Core_Domain_Attachment_Command_["src/Core/Domain/Attachment/Command/"]
        src_Core_Domain_Product_SpecificPrice_Command_AddSpecificPriceCommand_php["src/Core/Domain/Product/SpecificPrice/Command/AddSpecificPriceCommand.php"]
        src_Core_Domain_Product_Command_AddProductCommand_php["src/Core/Domain/Product/Command/AddProductCommand.php"]
        src_Core_Domain_Product_CommandHandler_AddProductHandler_php["src/Core/Domain/Product/CommandHandler/AddProductHandler.php"]
        src_Core_Domain_Product_Command_UpdateProductCommand_php["src/Core/Domain/Product/Command/UpdateProductCommand.php"]
        src_Core_Domain_Product_Command_DeleteProductCommand_php["src/Core/Domain/Product/Command/DeleteProductCommand.php"]
        src_Core_Domain_Product_Command_BulkDeleteProductCommand_php["src/Core/Domain/Product/Command/BulkDeleteProductCommand.php"]
        src_Core_Domain_Product_Command_DuplicateProductCommand_php["src/Core/Domain/Product/Command/DuplicateProductCommand.php"]
        src_Core_Domain_Product_Query_SearchProductsQuery_php["src/Core/Domain/Product/Query/SearchProductsQuery.php"]
        src_Core_Domain_Product_Query_GetProductForEditingQuery_php["src/Core/Domain/Product/Query/GetProductForEditingQuery.php"]
        src_Core_Domain_Manufacturer_Command_AddManufacturerCommand_php["src/Core/Domain/Manufacturer/Command/AddManufacturerCommand.php"]
        src_Core_Domain_Supplier_Command_AddSupplierCommand_php["src/Core/Domain/Supplier/Command/AddSupplierCommand.php"]
        src_Core_Domain_Cart_Command_CreateEmptyCustomerCartCommand_php["src/Core/Domain/Cart/Command/CreateEmptyCustomerCartCommand.php"]
        src_Core_Domain_Cart_Command_UpdateCartAddressesCommand_php["src/Core/Domain/Cart/Command/UpdateCartAddressesCommand.php"]
        src_Core_Domain_Cart_Command_UpdateCartCarrierCommand_php["src/Core/Domain/Cart/Command/UpdateCartCarrierCommand.php"]
        src_Core_Domain_Cart_Command_UpdateCartDeliverySettingsCommand_php["src/Core/Domain/Cart/Command/UpdateCartDeliverySettingsCommand.php"]
        src_Core_Domain_Cart_Command_UpdateCartCurrencyCommand_php["src/Core/Domain/Cart/Command/UpdateCartCurrencyCommand.php"]
        src_Core_Domain_Cart_Command_UpdateCartLanguageCommand_php["src/Core/Domain/Cart/Command/UpdateCartLanguageCommand.php"]
        src_Core_Domain_Cart_Command_DeleteCartCommand_php["src/Core/Domain/Cart/Command/DeleteCartCommand.php"]
        src_Core_Domain_Cart_Command_BulkDeleteCartCommand_php["src/Core/Domain/Cart/Command/BulkDeleteCartCommand.php"]
        src_Core_Domain_Cart_Command_SendCartToCustomerCommand_php["src/Core/Domain/Cart/Command/SendCartToCustomerCommand.php"]
        src_Core_Domain_Cart_Query_GetCartForViewing_php["src/Core/Domain/Cart/Query/GetCartForViewing.php"]
        src_Core_Domain_Cart_Query_GetCartForOrderCreation_php["src/Core/Domain/Cart/Query/GetCartForOrderCreation.php"]
        src_Core_Domain_Cart_Query_GetLastEmptyCustomerCart_php["src/Core/Domain/Cart/Query/GetLastEmptyCustomerCart.php"]
        src_Core_Domain_Cart_Exception_CartNotFoundException_php["src/Core/Domain/Cart/Exception/CartNotFoundException.php"]
        src_Core_Domain_Cart_Exception_CannotDeleteOrderedCartException_php["src/Core/Domain/Cart/Exception/CannotDeleteOrderedCartException.php"]
        src_Core_Domain_Cart_Exception_CannotUpdateCartException_php["src/Core/Domain/Cart/Exception/CannotUpdateCartException.php"]
        src_Core_Domain_Cart_Command_RemoveProductFromCartCommand_php["src/Core/Domain/Cart/Command/RemoveProductFromCartCommand.php"]
        src_Core_Domain_Cart_Command_UpdateProductQuantityInCartCommand_php["src/Core/Domain/Cart/Command/UpdateProductQuantityInCartCommand.php"]
        src_Core_Domain_Cart_Command_UpdateProductPriceInCartCommand_php["src/Core/Domain/Cart/Command/UpdateProductPriceInCartCommand.php"]
        src_Core_Domain_Cart_Command_AddCustomizationCommand_php["src/Core/Domain/Cart/Command/AddCustomizationCommand.php"]
        src_Core_Domain_Cart_Exception_MinimalQuantityException_php["src/Core/Domain/Cart/Exception/MinimalQuantityException.php"]
        src_Core_Domain_Cart_Exception_CartConstraintException_php["src/Core/Domain/Cart/Exception/CartConstraintException.php"]
        src_Core_Domain_Cart_Command_AddCartRuleToCartCommand_php["src/Core/Domain/Cart/Command/AddCartRuleToCartCommand.php"]
        src_Core_Domain_Cart_Command_RemoveCartRuleFromCartCommand_php["src/Core/Domain/Cart/Command/RemoveCartRuleFromCartCommand.php"]
        src_Core_Domain_Discount_Command_UpdateDiscountCommand_php["src/Core/Domain/Discount/Command/UpdateDiscountCommand.php"]
        src_Core_Domain_Discount_Command_DeleteDiscountCommand_php["src/Core/Domain/Discount/Command/DeleteDiscountCommand.php"]
        src_Core_Domain_Discount_Command_BulkDeleteDiscountsCommand_php["src/Core/Domain/Discount/Command/BulkDeleteDiscountsCommand.php"]
        src_Core_Domain_Discount_Command_DuplicateDiscountCommand_php["src/Core/Domain/Discount/Command/DuplicateDiscountCommand.php"]
        src_Core_Domain_Discount_Command_BulkUpdateDiscountsStatusCommand_php["src/Core/Domain/Discount/Command/BulkUpdateDiscountsStatusCommand.php"]
        src_Core_Domain_Discount_Query_GetDiscountForEditing_php["src/Core/Domain/Discount/Query/GetDiscountForEditing.php"]
        src_Core_Domain_Discount_Query_GetDiscountTypes_php["src/Core/Domain/Discount/Query/GetDiscountTypes.php"]
        src_Core_Domain_CatalogPriceRule_Command_DeleteCatalogPriceRuleCommand_php["src/Core/Domain/CatalogPriceRule/Command/DeleteCatalogPriceRuleCommand.php"]
        src_Core_Domain_CatalogPriceRule_Command_BulkDeleteCatalogPriceRuleCommand_php["src/Core/Domain/CatalogPriceRule/Command/BulkDeleteCatalogPriceRuleCommand.php"]
        src_Core_Domain_CatalogPriceRule_Query_GetCatalogPriceRuleForEditing_php["src/Core/Domain/CatalogPriceRule/Query/GetCatalogPriceRuleForEditing.php"]
        src_Core_Domain_CatalogPriceRule_Query_GetCatalogPriceRuleListForProduct_php["src/Core/Domain/CatalogPriceRule/Query/GetCatalogPriceRuleListForProduct.php"]
        src_Core_Domain_CmsPage_CommandHandler_AddCmsPageHandler_php["src/Core/Domain/CmsPage/CommandHandler/AddCmsPageHandler.php"]
        src_Core_Domain_CmsPage_Command_EditCmsPageCommand_php["src/Core/Domain/CmsPage/Command/EditCmsPageCommand.php"]
        src_Core_Domain_CmsPage_CommandHandler_EditCmsPageHandler_php["src/Core/Domain/CmsPage/CommandHandler/EditCmsPageHandler.php"]
        src_Core_Domain_CmsPage_Command_DeleteCmsPageCommand_php["src/Core/Domain/CmsPage/Command/DeleteCmsPageCommand.php"]
        src_Core_Domain_CmsPage_CommandHandler_DeleteCmsPageHandler_php["src/Core/Domain/CmsPage/CommandHandler/DeleteCmsPageHandler.php"]
        src_Core_Domain_CmsPage_Command_BulkDeleteCmsPageCommand_php["src/Core/Domain/CmsPage/Command/BulkDeleteCmsPageCommand.php"]
        src_Core_Domain_CmsPage_Command_ToggleCmsPageStatusCommand_php["src/Core/Domain/CmsPage/Command/ToggleCmsPageStatusCommand.php"]
        src_Core_Domain_CmsPage_Command_BulkEnableCmsPageCommand_php["src/Core/Domain/CmsPage/Command/BulkEnableCmsPageCommand.php"]
        src_Core_Domain_CmsPage_Command_BulkDisableCmsPageCommand_php["src/Core/Domain/CmsPage/Command/BulkDisableCmsPageCommand.php"]
        src_Core_Domain_CmsPage_Query_GetCmsPageForEditing_php["src/Core/Domain/CmsPage/Query/GetCmsPageForEditing.php"]
        src_Core_Domain_CmsPage_QueryResult_EditableCmsPage_php["src/Core/Domain/CmsPage/QueryResult/EditableCmsPage.php"]
        src_Core_Domain_CmsPage_Query_GetCmsCategoryIdForRedirection_php["src/Core/Domain/CmsPage/Query/GetCmsCategoryIdForRedirection.php"]
        src_Core_Domain_CmsPageCategory_CommandHandler_AddCmsPageCategoryHandler_php["src/Core/Domain/CmsPageCategory/CommandHandler/AddCmsPageCategoryHandler.php"]
        src_Core_Domain_CmsPageCategory_Command_EditCmsPageCategoryCommand_php["src/Core/Domain/CmsPageCategory/Command/EditCmsPageCategoryCommand.php"]
        src_Core_Domain_CmsPageCategory_CommandHandler_EditCmsPageCategoryHandler_php["src/Core/Domain/CmsPageCategory/CommandHandler/EditCmsPageCategoryHandler.php"]
        src_Core_Domain_CmsPageCategory_Command_DeleteCmsPageCategoryCommand_php["src/Core/Domain/CmsPageCategory/Command/DeleteCmsPageCategoryCommand.php"]
        src_Core_Domain_CmsPageCategory_CommandHandler_DeleteCmsPageCategoryHandler_php["src/Core/Domain/CmsPageCategory/CommandHandler/DeleteCmsPageCategoryHandler.php"]
        src_Core_Domain_CmsPageCategory_Command_BulkDeleteCmsPageCategoryCommand_php["src/Core/Domain/CmsPageCategory/Command/BulkDeleteCmsPageCategoryCommand.php"]
        src_Core_Domain_CmsPageCategory_Command_ToggleCmsPageCategoryStatusCommand_php["src/Core/Domain/CmsPageCategory/Command/ToggleCmsPageCategoryStatusCommand.php"]
        src_Core_Domain_CmsPageCategory_Command_BulkEnableCmsPageCategoryCommand_php["src/Core/Domain/CmsPageCategory/Command/BulkEnableCmsPageCategoryCommand.php"]
        src_Core_Domain_CmsPageCategory_Command_BulkDisableCmsPageCategoryCommand_php["src/Core/Domain/CmsPageCategory/Command/BulkDisableCmsPageCategoryCommand.php"]
        src_Core_Domain_CmsPageCategory_Query_GetCmsPageCategoryForEditing_php["src/Core/Domain/CmsPageCategory/Query/GetCmsPageCategoryForEditing.php"]
        src_Core_Domain_CmsPageCategory_QueryResult_EditableCmsPageCategory_php["src/Core/Domain/CmsPageCategory/QueryResult/EditableCmsPageCategory.php"]
        src_Core_Domain_CmsPageCategory_Query_GetCmsPageCategoriesForBreadcrumb_php["src/Core/Domain/CmsPageCategory/Query/GetCmsPageCategoriesForBreadcrumb.php"]
        src_Core_Domain_CmsPageCategory_QueryResult_Breadcrumb_php["src/Core/Domain/CmsPageCategory/QueryResult/Breadcrumb.php"]
        src_Core_Domain_CmsPageCategory_QueryResult_BreadcrumbItem_php["src/Core/Domain/CmsPageCategory/QueryResult/BreadcrumbItem.php"]
        src_Core_Domain_CmsPageCategory_Query_GetCmsPageCategoryNameForListing_php["src/Core/Domain/CmsPageCategory/Query/GetCmsPageCategoryNameForListing.php"]
        src_Core_Domain_CmsPageCategory_Query_GetCmsPageParentCategoryIdForRedirection_php["src/Core/Domain/CmsPageCategory/Query/GetCmsPageParentCategoryIdForRedirection.php"]
        src_Core_Domain_Meta_CommandHandler_AddMetaHandler_php["src/Core/Domain/Meta/CommandHandler/AddMetaHandler.php"]
        src_Core_Domain_Meta_Command_EditMetaCommand_php["src/Core/Domain/Meta/Command/EditMetaCommand.php"]
        src_Core_Domain_Meta_CommandHandler_EditMetaHandler_php["src/Core/Domain/Meta/CommandHandler/EditMetaHandler.php"]
        src_Core_Domain_Meta_Query_GetMetaForEditing_php["src/Core/Domain/Meta/Query/GetMetaForEditing.php"]
        src_Core_Domain_Meta_QueryResult_EditableMeta_php["src/Core/Domain/Meta/QueryResult/EditableMeta.php"]
        src_Core_Domain_Meta_Query_GetPagesForLayoutCustomization_php["src/Core/Domain/Meta/Query/GetPagesForLayoutCustomization.php"]
        src_Core_Domain_Meta_QueryResult_LayoutCustomizationPage_php["src/Core/Domain/Meta/QueryResult/LayoutCustomizationPage.php"]
        src_Core_Domain_Theme_Command_ImportThemeCommand_php["src/Core/Domain/Theme/Command/ImportThemeCommand.php"]
        src_Core_Domain_Theme_CommandHandler_ImportThemeHandler_php["src/Core/Domain/Theme/CommandHandler/ImportThemeHandler.php"]
        src_Core_Domain_Theme_CommandHandler_EnableThemeHandler_php["src/Core/Domain/Theme/CommandHandler/EnableThemeHandler.php"]
        src_Core_Domain_Theme_Command_DeleteThemeCommand_php["src/Core/Domain/Theme/Command/DeleteThemeCommand.php"]
        src_Core_Domain_Theme_CommandHandler_DeleteThemeHandler_php["src/Core/Domain/Theme/CommandHandler/DeleteThemeHandler.php"]
        src_Core_Domain_Theme_Command_ResetThemeLayoutsCommand_php["src/Core/Domain/Theme/Command/ResetThemeLayoutsCommand.php"]
        src_Core_Domain_Theme_CommandHandler_ResetThemeLayoutsHandler_php["src/Core/Domain/Theme/CommandHandler/ResetThemeLayoutsHandler.php"]
        src_Core_Domain_Theme_Command_AdaptThemeToRTLLanguagesCommand_php["src/Core/Domain/Theme/Command/AdaptThemeToRTLLanguagesCommand.php"]
        src_Core_Domain_Theme_CommandHandler_AdaptThemeToRTLLanguagesHandler_php["src/Core/Domain/Theme/CommandHandler/AdaptThemeToRTLLanguagesHandler.php"]
        src_Core_Domain_MailTemplate_Command_GenerateThemeMailTemplatesCommand_php["src/Core/Domain/MailTemplate/Command/GenerateThemeMailTemplatesCommand.php"]
        src_Core_Domain_MailTemplate_CommandHandler_GenerateThemeMailTemplatesHandler_php["src/Core/Domain/MailTemplate/CommandHandler/GenerateThemeMailTemplatesHandler.php"]
        src_Core_Domain_Address_Command_EditCustomerAddressCommand_php["src/Core/Domain/Address/Command/EditCustomerAddressCommand.php"]
        src_Core_Domain_Address_Command_DeleteAddressCommand_php["src/Core/Domain/Address/Command/DeleteAddressCommand.php"]
        src_Core_Domain_Address_Command_BulkDeleteAddressCommand_php["src/Core/Domain/Address/Command/BulkDeleteAddressCommand.php"]
        src_Core_Domain_Address_Command_SetRequiredFieldsForAddressCommand_php["src/Core/Domain/Address/Command/SetRequiredFieldsForAddressCommand.php"]
        src_Core_Domain_Address_Query_GetCustomerAddressForEditing_php["src/Core/Domain/Address/Query/GetCustomerAddressForEditing.php"]
        src_Core_Domain_Address_Query_GetRequiredFieldsForAddress_php["src/Core/Domain/Address/Query/GetRequiredFieldsForAddress.php"]
        src_Core_Domain_Customer_Command_DeleteCustomerCommand_php["src/Core/Domain/Customer/Command/DeleteCustomerCommand.php"]
        src_Core_Domain_Customer_Command_BulkDeleteCustomerCommand_php["src/Core/Domain/Customer/Command/BulkDeleteCustomerCommand.php"]
        src_Core_Domain_Customer_Command_BulkEnableCustomerCommand_php["src/Core/Domain/Customer/Command/BulkEnableCustomerCommand.php"]
        src_Core_Domain_Customer_Command_BulkDisableCustomerCommand_php["src/Core/Domain/Customer/Command/BulkDisableCustomerCommand.php"]
        src_Core_Domain_Customer_Command_SetPrivateNoteAboutCustomerCommand_php["src/Core/Domain/Customer/Command/SetPrivateNoteAboutCustomerCommand.php"]
        src_Core_Domain_Customer_Command_SetRequiredFieldsForCustomerCommand_php["src/Core/Domain/Customer/Command/SetRequiredFieldsForCustomerCommand.php"]
        src_Core_Domain_Customer_Command_TransformGuestToCustomerCommand_php["src/Core/Domain/Customer/Command/TransformGuestToCustomerCommand.php"]
        src_Core_Domain_Customer_Query_GetCustomerForEditing_php["src/Core/Domain/Customer/Query/GetCustomerForEditing.php"]
        src_Core_Domain_Customer_Query_GetCustomerForViewing_php["src/Core/Domain/Customer/Query/GetCustomerForViewing.php"]
        src_Core_Domain_Customer_Query_SearchCustomers_php["src/Core/Domain/Customer/Query/SearchCustomers.php"]
        src_Core_Domain_Customer_Query_GetCustomerForAddressCreation_php["src/Core/Domain/Customer/Query/GetCustomerForAddressCreation.php"]
        src_Core_Domain_Customer_Query_GetCustomerCarts_php["src/Core/Domain/Customer/Query/GetCustomerCarts.php"]
        src_Core_Domain_Customer_Query_GetCustomerOrders_php["src/Core/Domain/Customer/Query/GetCustomerOrders.php"]
        src_Core_Domain_Customer_Query_GetRequiredFieldsForCustomer_php["src/Core/Domain/Customer/Query/GetRequiredFieldsForCustomer.php"]
        src_Core_Domain_Customer_Group_Command_EditCustomerGroupCommand_php["src/Core/Domain/Customer/Group/Command/EditCustomerGroupCommand.php"]
        src_Core_Domain_Customer_Group_Command_DeleteCustomerGroupCommand_php["src/Core/Domain/Customer/Group/Command/DeleteCustomerGroupCommand.php"]
        src_Core_Domain_Customer_Group_Query_GetCustomerGroupForEditing_php["src/Core/Domain/Customer/Group/Query/GetCustomerGroupForEditing.php"]
        src_Core_Domain_CustomerService_Command_ForwardCustomerThreadCommand_php["src/Core/Domain/CustomerService/Command/ForwardCustomerThreadCommand.php"]
        src_Core_Domain_CustomerService_Command_UpdateCustomerThreadStatusCommand_php["src/Core/Domain/CustomerService/Command/UpdateCustomerThreadStatusCommand.php"]
        src_Core_Domain_CustomerService_Command_DeleteCustomerThreadCommand_php["src/Core/Domain/CustomerService/Command/DeleteCustomerThreadCommand.php"]
        src_Core_Domain_CustomerService_Command_BulkDeleteCustomerThreadCommand_php["src/Core/Domain/CustomerService/Command/BulkDeleteCustomerThreadCommand.php"]
        src_Core_Domain_CustomerService_Query_GetCustomerThreadForViewing_php["src/Core/Domain/CustomerService/Query/GetCustomerThreadForViewing.php"]
        src_Core_Domain_CustomerService_Query_GetCustomerServiceSignature_php["src/Core/Domain/CustomerService/Query/GetCustomerServiceSignature.php"]
        src_Core_Domain_Title_Command_EditTitleCommand_php["src/Core/Domain/Title/Command/EditTitleCommand.php"]
        src_Core_Domain_Title_Command_DeleteTitleCommand_php["src/Core/Domain/Title/Command/DeleteTitleCommand.php"]
        src_Core_Domain_Title_Command_BulkDeleteTitleCommand_php["src/Core/Domain/Title/Command/BulkDeleteTitleCommand.php"]
        src_Core_Domain_Title_Query_GetTitleForEditing_php["src/Core/Domain/Title/Query/GetTitleForEditing.php"]
        src_Core_Domain_Currency_Command_AddCurrencyCommand_php["src/Core/Domain/Currency/Command/AddCurrencyCommand.php"]
        src_Core_Domain_Currency_Command_AddUnofficialCurrencyCommand_php["src/Core/Domain/Currency/Command/AddUnofficialCurrencyCommand.php"]
        src_Core_Domain_Currency_Command_EditCurrencyCommand_php["src/Core/Domain/Currency/Command/EditCurrencyCommand.php"]
        src_Core_Domain_Currency_Command_EditUnofficialCurrencyCommand_php["src/Core/Domain/Currency/Command/EditUnofficialCurrencyCommand.php"]
        src_Core_Domain_Currency_Command_AbstractEditCurrencyCommand_php["src/Core/Domain/Currency/Command/AbstractEditCurrencyCommand.php"]
        src_Core_Domain_Currency_Command_DeleteCurrencyCommand_php["src/Core/Domain/Currency/Command/DeleteCurrencyCommand.php"]
        src_Core_Domain_Currency_Command_BulkDeleteCurrenciesCommand_php["src/Core/Domain/Currency/Command/BulkDeleteCurrenciesCommand.php"]
        src_Core_Domain_Currency_Command_ToggleCurrencyStatusCommand_php["src/Core/Domain/Currency/Command/ToggleCurrencyStatusCommand.php"]
        src_Core_Domain_Currency_Command_BulkToggleCurrenciesStatusCommand_php["src/Core/Domain/Currency/Command/BulkToggleCurrenciesStatusCommand.php"]
        src_Core_Domain_Currency_Command_RefreshExchangeRatesCommand_php["src/Core/Domain/Currency/Command/RefreshExchangeRatesCommand.php"]
        src_Core_Domain_Currency_Query_GetCurrencyForEditing_php["src/Core/Domain/Currency/Query/GetCurrencyForEditing.php"]
        src_Core_Domain_Currency_Query_GetCurrencyExchangeRate_php["src/Core/Domain/Currency/Query/GetCurrencyExchangeRate.php"]
        src_Core_Domain_Currency_Query_GetReferenceCurrency_php["src/Core/Domain/Currency/Query/GetReferenceCurrency.php"]
        src_Core_Domain_Country_Command_EditCountryCommand_php["src/Core/Domain/Country/Command/EditCountryCommand.php"]
        src_Core_Domain_Country_Command_DeleteCountryCommand_php["src/Core/Domain/Country/Command/DeleteCountryCommand.php"]
        src_Core_Domain_State_Command_DeleteStateCommand_php["src/Core/Domain/State/Command/DeleteStateCommand.php"]
        src_Core_Domain_State_Command_BulkDeleteStateCommand_php["src/Core/Domain/State/Command/BulkDeleteStateCommand.php"]
        src_Core_Domain_State_Command_ToggleStateStatusCommand_php["src/Core/Domain/State/Command/ToggleStateStatusCommand.php"]
        src_Core_Domain_State_Command_BulkToggleStateStatusCommand_php["src/Core/Domain/State/Command/BulkToggleStateStatusCommand.php"]
        src_Core_Domain_State_Command_BulkUpdateStateZoneCommand_php["src/Core/Domain/State/Command/BulkUpdateStateZoneCommand.php"]
        src_Core_Domain_Zone_Command_DeleteZoneCommand_php["src/Core/Domain/Zone/Command/DeleteZoneCommand.php"]
        src_Core_Domain_Zone_Command_BulkDeleteZoneCommand_php["src/Core/Domain/Zone/Command/BulkDeleteZoneCommand.php"]
        src_Core_Domain_Zone_Command_ToggleZoneStatusCommand_php["src/Core/Domain/Zone/Command/ToggleZoneStatusCommand.php"]
        src_Core_Domain_Zone_Command_BulkToggleZoneStatusCommand_php["src/Core/Domain/Zone/Command/BulkToggleZoneStatusCommand.php"]
        src_Core_Domain_Country_Query_GetCountryForEditing_php["src/Core/Domain/Country/Query/GetCountryForEditing.php"]
        src_Core_Domain_Country_Query_GetCountryRequiredFields_php["src/Core/Domain/Country/Query/GetCountryRequiredFields.php"]
        src_Core_Domain_State_Query_GetStateForEditing_php["src/Core/Domain/State/Query/GetStateForEditing.php"]
        src_Core_Domain_Zone_Query_GetZoneForEditing_php["src/Core/Domain/Zone/Query/GetZoneForEditing.php"]
        src_Core_Domain_Language_Command_DeleteLanguageCommand_php["src/Core/Domain/Language/Command/DeleteLanguageCommand.php"]
        src_Core_Domain_Language_Command_BulkDeleteLanguagesCommand_php["src/Core/Domain/Language/Command/BulkDeleteLanguagesCommand.php"]
        src_Core_Domain_Language_Command_ToggleLanguageStatusCommand_php["src/Core/Domain/Language/Command/ToggleLanguageStatusCommand.php"]
        src_Core_Domain_Language_Command_BulkToggleLanguagesStatusCommand_php["src/Core/Domain/Language/Command/BulkToggleLanguagesStatusCommand.php"]
        src_Core_Domain_Language_Query_GetLanguageForEditing_php["src/Core/Domain/Language/Query/GetLanguageForEditing.php"]
        src_Core_Domain_Tax_Command_DeleteTaxCommand_php["src/Core/Domain/Tax/Command/DeleteTaxCommand.php"]
        src_Core_Domain_Tax_Command_BulkDeleteTaxCommand_php["src/Core/Domain/Tax/Command/BulkDeleteTaxCommand.php"]
        src_Core_Domain_Tax_Command_ToggleTaxStatusCommand_php["src/Core/Domain/Tax/Command/ToggleTaxStatusCommand.php"]
        src_Core_Domain_Tax_Command_BulkToggleTaxStatusCommand_php["src/Core/Domain/Tax/Command/BulkToggleTaxStatusCommand.php"]
        src_Core_Domain_TaxRulesGroup_Command_DeleteTaxRulesGroupCommand_php["src/Core/Domain/TaxRulesGroup/Command/DeleteTaxRulesGroupCommand.php"]
        src_Core_Domain_TaxRulesGroup_Command_BulkDeleteTaxRulesGroupCommand_php["src/Core/Domain/TaxRulesGroup/Command/BulkDeleteTaxRulesGroupCommand.php"]
        src_Core_Domain_TaxRulesGroup_Command_SetTaxRulesGroupStatusCommand_php["src/Core/Domain/TaxRulesGroup/Command/SetTaxRulesGroupStatusCommand.php"]
        src_Core_Domain_TaxRulesGroup_Command_BulkSetTaxRulesGroupStatusCommand_php["src/Core/Domain/TaxRulesGroup/Command/BulkSetTaxRulesGroupStatusCommand.php"]
        src_Core_Domain_Tax_Query_GetTaxForEditing_php["src/Core/Domain/Tax/Query/GetTaxForEditing.php"]
        src_Core_Domain_TaxRulesGroup_Query_GetTaxRulesGroupForEditing_php["src/Core/Domain/TaxRulesGroup/Query/GetTaxRulesGroupForEditing.php"]
        src_Core_Domain_Module_CommandHandler_InstallModuleHandlerInterface_php["src/Core/Domain/Module/CommandHandler/InstallModuleHandlerInterface.php"]
        src_Core_Domain_Module_Command_UninstallModuleCommand_php["src/Core/Domain/Module/Command/UninstallModuleCommand.php"]
        src_Core_Domain_Module_CommandHandler_UninstallModuleHandlerInterface_php["src/Core/Domain/Module/CommandHandler/UninstallModuleHandlerInterface.php"]
        src_Core_Domain_Module_Command_UpdateModuleStatusCommand_php["src/Core/Domain/Module/Command/UpdateModuleStatusCommand.php"]
        src_Core_Domain_Module_CommandHandler_UpdateModuleStatusHandlerInterface_php["src/Core/Domain/Module/CommandHandler/UpdateModuleStatusHandlerInterface.php"]
        src_Core_Domain_Module_Command_BulkToggleModuleStatusCommand_php["src/Core/Domain/Module/Command/BulkToggleModuleStatusCommand.php"]
        src_Core_Domain_Module_CommandHandler_BulkToggleModuleStatusHandlerInterface_php["src/Core/Domain/Module/CommandHandler/BulkToggleModuleStatusHandlerInterface.php"]
        src_Core_Domain_Module_Command_BulkUninstallModuleCommand_php["src/Core/Domain/Module/Command/BulkUninstallModuleCommand.php"]
        src_Core_Domain_Module_CommandHandler_BulkUninstallModuleHandlerInterface_php["src/Core/Domain/Module/CommandHandler/BulkUninstallModuleHandlerInterface.php"]
        src_Core_Domain_Module_Command_ResetModuleCommand_php["src/Core/Domain/Module/Command/ResetModuleCommand.php"]
        src_Core_Domain_Module_CommandHandler_ResetModuleHandlerInterface_php["src/Core/Domain/Module/CommandHandler/ResetModuleHandlerInterface.php"]
        src_Core_Domain_Module_Command_UpgradeModuleCommand_php["src/Core/Domain/Module/Command/UpgradeModuleCommand.php"]
        src_Core_Domain_Module_CommandHandler_UpgradeModuleHandlerInterface_php["src/Core/Domain/Module/CommandHandler/UpgradeModuleHandlerInterface.php"]
        src_Core_Domain_Module_Command_UploadModuleCommand_php["src/Core/Domain/Module/Command/UploadModuleCommand.php"]
        src_Core_Domain_Module_CommandHandler_UploadModuleHandlerInterface_php["src/Core/Domain/Module/CommandHandler/UploadModuleHandlerInterface.php"]
        src_Core_Domain_Module_Query_GetModuleInfos_php["src/Core/Domain/Module/Query/GetModuleInfos.php"]
        src_Core_Domain_Hook_CommandHandler_UpdateHookStatusCommandHandlerInterface_php["src/Core/Domain/Hook/CommandHandler/UpdateHookStatusCommandHandlerInterface.php"]
        src_Core_Domain_Hook_Query_GetHook_php["src/Core/Domain/Hook/Query/GetHook.php"]
        src_Core_Domain_Hook_Query_GetHookStatus_php["src/Core/Domain/Hook/Query/GetHookStatus.php"]
        src_Core_Domain_Hook_QueryResult_HookStatus_php["src/Core/Domain/Hook/QueryResult/HookStatus.php"]
        src_Core_Domain_Order_Invoice_Command_GenerateInvoiceCommand_php["src/Core/Domain/Order/Invoice/Command/GenerateInvoiceCommand.php"]
        src_Core_Domain_Order_Invoice_Command_UpdateInvoiceNoteCommand_php["src/Core/Domain/Order/Invoice/Command/UpdateInvoiceNoteCommand.php"]
        src_Core_Domain_Order_Payment_Command_AddPaymentCommand_php["src/Core/Domain/Order/Payment/Command/AddPaymentCommand.php"]
        src_Core_Domain_OrderState_Command_AddOrderStateCommand_php["src/Core/Domain/OrderState/Command/AddOrderStateCommand.php"]
        src_Core_Domain_OrderState_Command_EditOrderStateCommand_php["src/Core/Domain/OrderState/Command/EditOrderStateCommand.php"]
        src_Core_Domain_OrderState_Command_DeleteOrderStateCommand_php["src/Core/Domain/OrderState/Command/DeleteOrderStateCommand.php"]
        src_Core_Domain_OrderState_Command_BulkDeleteOrderStateCommand_php["src/Core/Domain/OrderState/Command/BulkDeleteOrderStateCommand.php"]
        src_Core_Domain_OrderMessage_Command_AddOrderMessageCommand_php["src/Core/Domain/OrderMessage/Command/AddOrderMessageCommand.php"]
        src_Core_Domain_OrderMessage_Command_EditOrderMessageCommand_php["src/Core/Domain/OrderMessage/Command/EditOrderMessageCommand.php"]
        src_Core_Domain_OrderMessage_Command_DeleteOrderMessageCommand_php["src/Core/Domain/OrderMessage/Command/DeleteOrderMessageCommand.php"]
        src_Core_Domain_OrderMessage_Command_BulkDeleteOrderMessageCommand_php["src/Core/Domain/OrderMessage/Command/BulkDeleteOrderMessageCommand.php"]
        src_Core_Domain_OrderReturnState_Command_AddOrderReturnStateCommand_php["src/Core/Domain/OrderReturnState/Command/AddOrderReturnStateCommand.php"]
        src_Core_Domain_OrderReturnState_Command_EditOrderReturnStateCommand_php["src/Core/Domain/OrderReturnState/Command/EditOrderReturnStateCommand.php"]
        src_Core_Domain_OrderReturnState_Command_DeleteOrderReturnStateCommand_php["src/Core/Domain/OrderReturnState/Command/DeleteOrderReturnStateCommand.php"]
        src_Core_Domain_OrderReturnState_Command_BulkDeleteOrderReturnStateCommand_php["src/Core/Domain/OrderReturnState/Command/BulkDeleteOrderReturnStateCommand.php"]
        src_Core_Domain_CustomerMessage_Command_AddOrderCustomerMessageCommand_php["src/Core/Domain/CustomerMessage/Command/AddOrderCustomerMessageCommand.php"]
        src_Core_Domain_Order_Command_AddOrderFromBackOfficeCommand_php["src/Core/Domain/Order/Command/AddOrderFromBackOfficeCommand.php"]
        src_Core_Domain_Order_CommandHandler_AddOrderFromBackOfficeHandler_php["src/Core/Domain/Order/CommandHandler/AddOrderFromBackOfficeHandler.php"]
        src_Core_Domain_Order_Command_UpdateOrderStatusCommand_php["src/Core/Domain/Order/Command/UpdateOrderStatusCommand.php"]
        src_Core_Domain_Order_CommandHandler_UpdateOrderStatusHandler_php["src/Core/Domain/Order/CommandHandler/UpdateOrderStatusHandler.php"]
        src_Core_Domain_Order_Command_CancelOrderProductCommand_php["src/Core/Domain/Order/Command/CancelOrderProductCommand.php"]
        src_Core_Domain_Order_Command_BulkChangeOrderStatusCommand_php["src/Core/Domain/Order/Command/BulkChangeOrderStatusCommand.php"]
        src_Core_Domain_Order_Command_DuplicateOrderCartCommand_php["src/Core/Domain/Order/Command/DuplicateOrderCartCommand.php"]
        src_Core_Domain_Order_Command_ChangeOrderCurrencyCommand_php["src/Core/Domain/Order/Command/ChangeOrderCurrencyCommand.php"]
        src_Core_Domain_Order_Command_ChangeOrderDeliveryAddressCommand_php["src/Core/Domain/Order/Command/ChangeOrderDeliveryAddressCommand.php"]
        src_Core_Domain_Order_Command_ChangeOrderInvoiceAddressCommand_php["src/Core/Domain/Order/Command/ChangeOrderInvoiceAddressCommand.php"]
        src_Core_Domain_Order_Command_AddCartRuleToOrderCommand_php["src/Core/Domain/Order/Command/AddCartRuleToOrderCommand.php"]
        src_Core_Domain_Order_Command_DeleteCartRuleFromOrderCommand_php["src/Core/Domain/Order/Command/DeleteCartRuleFromOrderCommand.php"]
        src_Core_Domain_Order_Command_SetInternalOrderNoteCommand_php["src/Core/Domain/Order/Command/SetInternalOrderNoteCommand.php"]
        src_Core_Domain_Order_Command_ResendOrderEmailCommand_php["src/Core/Domain/Order/Command/ResendOrderEmailCommand.php"]
        src_Core_Domain_Order_Command_SendProcessOrderEmailCommand_php["src/Core/Domain/Order/Command/SendProcessOrderEmailCommand.php"]
        src_Core_Domain_Order_Command_UpdateOrderShippingDetailsCommand_php["src/Core/Domain/Order/Command/UpdateOrderShippingDetailsCommand.php"]
        src_Core_Domain_Order_Query_GetOrderForViewing_php["src/Core/Domain/Order/Query/GetOrderForViewing.php"]
        src_Core_Domain_Order_QueryHandler_GetOrderForViewingHandler_php["src/Core/Domain/Order/QueryHandler/GetOrderForViewingHandler.php"]
        src_Core_Domain_Order_Query_GetOrderPreview_php["src/Core/Domain/Order/Query/GetOrderPreview.php"]
        src_Core_Domain_Order_Query_GetOrderProductsForViewing_php["src/Core/Domain/Order/Query/GetOrderProductsForViewing.php"]
        src_Core_Domain_Order_Product_Command_AddProductToOrderCommand_php["src/Core/Domain/Order/Product/Command/AddProductToOrderCommand.php"]
        src_Core_Domain_Order_Product_Command_DeleteProductFromOrderCommand_php["src/Core/Domain/Order/Product/Command/DeleteProductFromOrderCommand.php"]
        src_Core_Domain_Order_Product_Command_UpdateProductInOrderCommand_php["src/Core/Domain/Order/Product/Command/UpdateProductInOrderCommand.php"]
        src_Core_Domain_Order_Command_IssueStandardRefundCommand_php["src/Core/Domain/Order/Command/IssueStandardRefundCommand.php"]
        src_Core_Domain_Order_CommandHandler_IssueStandardRefundHandler_php["src/Core/Domain/Order/CommandHandler/IssueStandardRefundHandler.php"]
        src_Core_Domain_Order_Command_IssuePartialRefundCommand_php["src/Core/Domain/Order/Command/IssuePartialRefundCommand.php"]
        src_Core_Domain_Order_CommandHandler_IssuePartialRefundHandler_php["src/Core/Domain/Order/CommandHandler/IssuePartialRefundHandler.php"]
        src_Core_Domain_Order_Command_IssueReturnProductCommand_php["src/Core/Domain/Order/Command/IssueReturnProductCommand.php"]
        src_Core_Domain_Order_CommandHandler_IssueReturnProductHandler_php["src/Core/Domain/Order/CommandHandler/IssueReturnProductHandler.php"]
        src_Core_Domain_OrderReturn_Command_UpdateOrderReturnStateCommand_php["src/Core/Domain/OrderReturn/Command/UpdateOrderReturnStateCommand.php"]
        src_Core_Domain_Order_Query_GetCreditSlipIdsByDateRange_php["src/Core/Domain/Order/Query/GetCreditSlipIdsByDateRange.php"]
        src_Core_Domain_Carrier_CommandHandler_AddCarrierHandler_php["src/Core/Domain/Carrier/CommandHandler/AddCarrierHandler.php"]
        src_Core_Domain_Carrier_Command_EditCarrierCommand_php["src/Core/Domain/Carrier/Command/EditCarrierCommand.php"]
        src_Core_Domain_Carrier_CommandHandler_EditCarrierHandler_php["src/Core/Domain/Carrier/CommandHandler/EditCarrierHandler.php"]
        src_Core_Domain_Carrier_Command_DeleteCarrierCommand_php["src/Core/Domain/Carrier/Command/DeleteCarrierCommand.php"]
        src_Core_Domain_Carrier_CommandHandler_DeleteCarrierHandler_php["src/Core/Domain/Carrier/CommandHandler/DeleteCarrierHandler.php"]
        src_Core_Domain_Carrier_Command_BulkDeleteCarrierCommand_php["src/Core/Domain/Carrier/Command/BulkDeleteCarrierCommand.php"]
        src_Core_Domain_Carrier_Command_ToggleCarrierStatusCommand_php["src/Core/Domain/Carrier/Command/ToggleCarrierStatusCommand.php"]
        src_Core_Domain_Carrier_Command_BulkToggleCarrierStatusCommand_php["src/Core/Domain/Carrier/Command/BulkToggleCarrierStatusCommand.php"]
        src_Core_Domain_Carrier_Command_ToggleCarrierIsFreeCommand_php["src/Core/Domain/Carrier/Command/ToggleCarrierIsFreeCommand.php"]
        src_Core_Domain_Carrier_Command_SetCarrierRangesCommand_php["src/Core/Domain/Carrier/Command/SetCarrierRangesCommand.php"]
        src_Core_Domain_Carrier_Query_GetCarrierForEditing_php["src/Core/Domain/Carrier/Query/GetCarrierForEditing.php"]
        src_Core_Domain_Carrier_Query_GetCarrierRanges_php["src/Core/Domain/Carrier/Query/GetCarrierRanges.php"]
        src_Core_Domain_Carrier_Query_GetAvailableCarriers_php["src/Core/Domain/Carrier/Query/GetAvailableCarriers.php"]
        src_Core_Domain_Carrier_Query_GetCarriersForProduct_php["src/Core/Domain/Carrier/Query/GetCarriersForProduct.php"]
        src_Core_Domain_Carrier_Exception_CarrierNotFoundException_php["src/Core/Domain/Carrier/Exception/CarrierNotFoundException.php"]
        src_Core_Domain_Carrier_Exception_CarrierConstraintException_php["src/Core/Domain/Carrier/Exception/CarrierConstraintException.php"]
        src_Core_Domain_Carrier_Exception_CannotAddCarrierException_php["src/Core/Domain/Carrier/Exception/CannotAddCarrierException.php"]
        src_Core_Domain_Carrier_Exception_CannotUpdateCarrierException_php["src/Core/Domain/Carrier/Exception/CannotUpdateCarrierException.php"]
        src_Core_Domain_Carrier_Exception_CannotDeleteCarrierException_php["src/Core/Domain/Carrier/Exception/CannotDeleteCarrierException.php"]
        src_Core_Domain_Carrier_Exception_CannotToggleCarrierStatusException_php["src/Core/Domain/Carrier/Exception/CannotToggleCarrierStatusException.php"]
        src_Core_Domain_Carrier_Exception_CannotToggleCarrierIsFreeStatusException_php["src/Core/Domain/Carrier/Exception/CannotToggleCarrierIsFreeStatusException.php"]
        src_Core_Domain_Shipment_Command_EditShipment_php["src/Core/Domain/Shipment/Command/EditShipment.php"]
        src_Core_Domain_Shipment_Command_AddProductToShipment_php["src/Core/Domain/Shipment/Command/AddProductToShipment.php"]
        src_Core_Domain_Shipment_Command_DeleteProductFromShipment_php["src/Core/Domain/Shipment/Command/DeleteProductFromShipment.php"]
        src_Core_Domain_Shipment_Command_SplitShipment_php["src/Core/Domain/Shipment/Command/SplitShipment.php"]
        src_Core_Domain_Shipment_Service_ShipmentSplitterInterface_php["src/Core/Domain/Shipment/Service/ShipmentSplitterInterface.php"]
        src_Core_Domain_Shipment_Command_MergeProductsToShipment_php["src/Core/Domain/Shipment/Command/MergeProductsToShipment.php"]
        src_Core_Domain_Shipment_Service_ShipmentMergerInterface_php["src/Core/Domain/Shipment/Service/ShipmentMergerInterface.php"]
        src_Core_Domain_Shipment_Command_SwitchShipmentCarrierCommand_php["src/Core/Domain/Shipment/Command/SwitchShipmentCarrierCommand.php"]
        src_Core_Domain_Shipment_Query_GetOrderShipments_php["src/Core/Domain/Shipment/Query/GetOrderShipments.php"]
        src_Core_Domain_Shipment_Query_GetShipmentForEditing_php["src/Core/Domain/Shipment/Query/GetShipmentForEditing.php"]
        src_Core_Domain_Shipment_Query_GetShipmentForViewing_php["src/Core/Domain/Shipment/Query/GetShipmentForViewing.php"]
        src_Core_Domain_Shipment_Query_GetShipmentProducts_php["src/Core/Domain/Shipment/Query/GetShipmentProducts.php"]
        src_Core_Domain_Shipment_Query_GetShipmentsForOrderDetail_php["src/Core/Domain/Shipment/Query/GetShipmentsForOrderDetail.php"]
        src_Core_Domain_Shipment_Query_ListAvailableShipments_php["src/Core/Domain/Shipment/Query/ListAvailableShipments.php"]
        src_Core_Domain_Shipment_Query_ListAvailableShipmentsForProduct_php["src/Core/Domain/Shipment/Query/ListAvailableShipmentsForProduct.php"]
        src_Core_Domain_Shipment_Exception_ShipmentNotFoundException_php["src/Core/Domain/Shipment/Exception/ShipmentNotFoundException.php"]
        src_Core_Domain_Shipment_Exception_CannotEditShipmentShippedException_php["src/Core/Domain/Shipment/Exception/CannotEditShipmentShippedException.php"]
        src_Core_Domain_Shipment_Exception_CannotAddShipmentException_php["src/Core/Domain/Shipment/Exception/CannotAddShipmentException.php"]
        src_Core_Domain_Shipment_Exception_CannotSaveShipmentException_php["src/Core/Domain/Shipment/Exception/CannotSaveShipmentException.php"]
        src_Core_Domain_Shipment_Exception_CannotMergeProductToShipmentException_php["src/Core/Domain/Shipment/Exception/CannotMergeProductToShipmentException.php"]
        src_Core_Domain_Shop_Query_GetLogosPaths_php["src/Core/Domain/Shop/Query/GetLogosPaths.php"]
        src_Core_Domain_Shop_Query_SearchShops_php["src/Core/Domain/Shop/Query/SearchShops.php"]
        src_Core_Domain_Store_Command_BulkDeleteStoreCommand_php["src/Core/Domain/Store/Command/BulkDeleteStoreCommand.php"]
        src_Core_Domain_Store_Command_BulkUpdateStoreStatusCommand_php["src/Core/Domain/Store/Command/BulkUpdateStoreStatusCommand.php"]
        src_Core_Domain_Store_Query_GetStoreForEditing_php["src/Core/Domain/Store/Query/GetStoreForEditing.php"]
        src_Core_Domain_SearchEngine_Command_DeleteSearchEngineCommand_php["src/Core/Domain/SearchEngine/Command/DeleteSearchEngineCommand.php"]
        src_Core_Domain_SearchEngine_Command_BulkDeleteSearchEngineCommand_php["src/Core/Domain/SearchEngine/Command/BulkDeleteSearchEngineCommand.php"]
        src_Core_Domain_SearchEngine_Query_GetSearchEngineForEditing_php["src/Core/Domain/SearchEngine/Query/GetSearchEngineForEditing.php"]
        src_Core_Domain_Alias_Command_DeleteSearchTermAliasesCommand_php["src/Core/Domain/Alias/Command/DeleteSearchTermAliasesCommand.php"]
        src_Core_Domain_Alias_Command_BulkDeleteSearchTermsAliasesCommand_php["src/Core/Domain/Alias/Command/BulkDeleteSearchTermsAliasesCommand.php"]
        src_Core_Domain_Alias_Query_GetAliasForEditing_php["src/Core/Domain/Alias/Query/GetAliasForEditing.php"]
        src_Core_Domain_Alias_Query_GetAliasesBySearchTermForEditing_php["src/Core/Domain/Alias/Query/GetAliasesBySearchTermForEditing.php"]
        src_Core_Domain_Alias_Query_SearchForSearchTerm_php["src/Core/Domain/Alias/Query/SearchForSearchTerm.php"]
        src_Core_Domain_Contact_Query_GetContactForEditing_php["src/Core/Domain/Contact/Query/GetContactForEditing.php"]
        src_Core_Domain_Notification_Query_GetNotificationLastElements_php["src/Core/Domain/Notification/Query/GetNotificationLastElements.php"]
        src_Core_Domain_ShowcaseCard_Query_GetShowcaseCardIsClosed_php["src/Core/Domain/ShowcaseCard/Query/GetShowcaseCardIsClosed.php"]
        src_Core_Domain_Category_QueryResult_EditableCategory_php["src/Core/Domain/Category/QueryResult/EditableCategory.php"]
        src_Core_Domain_Combination_QueryResult_CombinationForEditing_php["src/Core/Domain/Combination/QueryResult/CombinationForEditing.php"]
        src_Core_Domain_Product_QueryResult_ProductForEditing_php["src/Core/Domain/Product/QueryResult/ProductForEditing.php"]
        src_Core_Domain_Product_QueryResult_FoundProduct_php["src/Core/Domain/Product/QueryResult/FoundProduct.php"]
        src_Core_Domain_Product_QueryResult_ProductPricesInformation_php["src/Core/Domain/Product/QueryResult/ProductPricesInformation.php"]
        src_Core_Domain_Product_QueryResult_ProductStockInformation_php["src/Core/Domain/Product/QueryResult/ProductStockInformation.php"]
        src_Core_Domain_Cart_QueryResult_CartForViewing_php["src/Core/Domain/Cart/QueryResult/CartForViewing.php"]
        src_Core_Domain_Customer_QueryResult_EditableCustomer_php["src/Core/Domain/Customer/QueryResult/EditableCustomer.php"]
        src_Core_Domain_Order_Command_AddPaymentCommand_php["src/Core/Domain/Order/Command/AddPaymentCommand.php"]
        src_Core_Domain_Order_QueryResult_OrderForViewing_php["src/Core/Domain/Order/QueryResult/OrderForViewing.php"]
        src_Core_Domain_Order_QueryResult_OrderPreview_php["src/Core/Domain/Order/QueryResult/OrderPreview.php"]
        src_Core_Domain_Store_Command_["src/Core/Domain/Store/Command/"]
        src_Core_Domain_Product_ValueObject_ProductType_php["src/Core/Domain/Product/ValueObject/ProductType.php"]
        src_Core_Domain_Category_CategorySettings_php["src/Core/Domain/Category/CategorySettings.php"]
        src_Core_Domain_Category_Exception_CategoryConstraintException_php["src/Core/Domain/Category/Exception/CategoryConstraintException.php"]
        src_Core_Domain_Category_Exception_CannotDeleteRootCategoryForShopException_php["src/Core/Domain/Category/Exception/CannotDeleteRootCategoryForShopException.php"]
        src_Adapter_Category_CommandHandler_DeleteCategoryHandler_php["src/Adapter/Category/CommandHandler/DeleteCategoryHandler.php"]
        src_Core_Domain_Product_Exception_CannotDeleteProductException_php["src/Core/Domain/Product/Exception/CannotDeleteProductException.php"]
        src_Adapter_Product_CommandHandler_DeleteProductHandler_php["src/Adapter/Product/CommandHandler/DeleteProductHandler.php"]
        src_Core_Domain_Product_SpecificPrice_Exception_SpecificPriceConstraintException_php["src/Core/Domain/Product/SpecificPrice/Exception/SpecificPriceConstraintException.php"]
        src_Core_Domain_Product_Combination_Command_GenerateProductCombinationsCommand_php["src/Core/Domain/Product/Combination/Command/GenerateProductCombinationsCommand.php"]
        src_Core_Domain_Product_Combination_Exception_CombinationConstraintException_php["src/Core/Domain/Product/Combination/Exception/CombinationConstraintException.php"]
        src_Core_Domain_Discount_Exception_DiscountConstraintException_php["src/Core/Domain/Discount/Exception/DiscountConstraintException.php"]
        src_Core_Domain_CartRule_Exception_CartRuleValidityException_php["src/Core/Domain/CartRule/Exception/CartRuleValidityException.php"]
        src_Core_Domain_Discount_ValueObject_MinimumAmount_php["src/Core/Domain/Discount/ValueObject/MinimumAmount.php"]
        src_Core_Domain_CartRule_Exception_CartRuleConstraintException_php["src/Core/Domain/CartRule/Exception/CartRuleConstraintException.php"]
        src_Core_Domain_Customer_Exception_DuplicateCustomerEmailException_php["src/Core/Domain/Customer/Exception/DuplicateCustomerEmailException.php"]
        src_Adapter_Customer_CommandHandler_AddCustomerHandler_php["src/Adapter/Customer/CommandHandler/AddCustomerHandler.php"]
        src_Core_Domain_Customer_ValueObject_Password_php["src/Core/Domain/Customer/ValueObject/Password.php"]
        src_Core_Security_PasswordPolicyConfiguration_php["src/Core/Security/PasswordPolicyConfiguration.php"]
        src_Core_Domain_Customer_Exception_CustomerTransformationException_php["src/Core/Domain/Customer/Exception/CustomerTransformationException.php"]
        src_Core_Domain_Address_Exception_AddressConstraintException_php["src/Core/Domain/Address/Exception/AddressConstraintException.php"]
        src_Core_Domain_Address_Configuration_AddressConstraint_php["src/Core/Domain/Address/Configuration/AddressConstraint.php"]
        src_Core_Domain_Module_Exception_ModuleNotInstalledException_php["src/Core/Domain/Module/Exception/ModuleNotInstalledException.php"]
        src_Core_Domain_Module_Exception_ModuleConstraintException_php["src/Core/Domain/Module/Exception/ModuleConstraintException.php"]
        src_Core_Domain_Module_Exception_CannotResetModuleException_php["src/Core/Domain/Module/Exception/CannotResetModuleException.php"]
        src_Core_Domain_Module_Exception_ModuleAlreadyUpToDateException_php["src/Core/Domain/Module/Exception/ModuleAlreadyUpToDateException.php"]
        src_Core_Domain_Order_OrderConstraints_php["src/Core/Domain/Order/OrderConstraints.php"]
        src_Core_Domain_Order_Exception_InvalidProductQuantityException_php["src/Core/Domain/Order/Exception/InvalidProductQuantityException.php"]
        src_Core_Domain_Order_Invoice_Exception_InvoiceException_php["src/Core/Domain/Order/Invoice/Exception/InvoiceException.php"]
        src_Core_Domain_Order_Exception_InvalidOrderStateException_php["src/Core/Domain/Order/Exception/InvalidOrderStateException.php"]
        src_Core_Domain_Order_Exception_NegativePaymentAmountException_php["src/Core/Domain/Order/Exception/NegativePaymentAmountException.php"]
        src_Core_Domain_Order_Exception_ReturnProductDisabledException_php["src/Core/Domain/Order/Exception/ReturnProductDisabledException.php"]
        src_Core_Domain_Order_Exception_InvalidRefundException_php["src/Core/Domain/Order/Exception/InvalidRefundException.php"]
        src_Adapter_Order_CommandHandler_UpdateOrderStatusHandler_php["src/Adapter/Order/CommandHandler/UpdateOrderStatusHandler.php"]
        src_Core_Domain_Order_Exception_ChangeOrderStatusException_php["src/Core/Domain/Order/Exception/ChangeOrderStatusException.php"]
        src_Core_Domain_Order_Event_["src/Core/Domain/Order/Event/"]
        src_Core_Domain_Order_Payment_["src/Core/Domain/Order/Payment/"]
        src_Core_Domain_Cart_["src/Core/Domain/Cart/"]
        src_Core_Domain_["src/Core/Domain/"]
        https___github_com_PrestaShop_docs_blob_9_x_development_architecture_domain__index_md["https://github.com/PrestaShop/docs/blob/9.x/development/architecture/domain/_index.md"]
        src_PrestaShopBundle_["src/PrestaShopBundle/"]
        https___github_com_PrestaShop_docs_blob_9_x_development_architecture_migration_guide__index_md["https://github.com/PrestaShop/docs/blob/9.x/development/architecture/migration-guide/_index.md"]
        src_Core_Domain_ApiClient_["src/Core/Domain/ApiClient/"]
        https___github_com_PrestaShop_docs_blob_9_x_development_webservice__index_md["https://github.com/PrestaShop/docs/blob/9.x/development/webservice/_index.md"]
    end
