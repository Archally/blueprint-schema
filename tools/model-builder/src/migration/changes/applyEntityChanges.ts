...
export const MIGRATION_ENTITY_TYPE_MAP: Record<string, TypeMapping> = {
  ...
  story:            { type: ENTITY_TYPE.Process,               layer: SCHEMA_TYPE_TO_LAYER['process']! },
  activity:         { type: ENTITY_TYPE.Process,               layer: SCHEMA_TYPE_TO_LAYER['process']! },
  'user-story':     { type: ENTITY_TYPE.UserStory,           layer: SCHEMA_TYPE_TO_LAYER['process']! },
  'use-case':       { type: ENTITY_TYPE.UseCase,             layer: SCHEMA_TYPE_TO_LAYER['process']! },
